...
var G__53406 = o;
reagent.impl.template.goog$module$goog$object.set(G__53406,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__53604__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__53604 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__53606__i = 0, G__53606__a = new Array(arguments.length -  0);
while (G__53606__i < G__53606__a.length) {G__53606__a[G__53606__i] = arguments[G__53606__i + 0]; ++G__53606__i;}
  args = new cljs.core.IndexedSeq(G__53606__a,0,null);
} 
return G__53604__delegate.call(this,args);};
G__53604.cljs$lang$maxFixedArity = 0;
G__53604.cljs$lang$applyTo = (function (arglist__53607){
var args = cljs.core.seq(arglist__53607);
return G__53604__delegate(args);
});
...
var G__53437 = o;
reagent.impl.template.goog$module$goog$object.set(G__53437,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__53617__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__53619__i < G__53619__a.length) {G__53619__a[G__53619__i] = arguments[G__53619__i + 0]; ++G__53619__i;}
  args = new cljs.core.IndexedSeq(G__53619__a,0,null);
} 
return G__53617__delegate.call(this,args);};
G__53617.cljs$lang$maxFixedArity = 0;
G__53617.cljs$lang$applyTo = (function (arglist__53620){
var args = cljs.core.seq(arglist__53620);
return G__53617__delegate(args);
});
...
var G__53448 = props;
var G__53448__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__53448,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__53448);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__53448__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__53459 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__53459,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__53459;
}
})(),id_class);
...
var G__53470 = (cljs.core.count(argv) - first_child);
switch (G__53470) {
case (0):
...
var vec__53486 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53486,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53486,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53486,(2),null);
...
var temp__5757__auto___53631 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___53631 == null)){
} else {
var key_53632 = temp__5757__auto___53631;
(jsprops.key = key_53632);
}
...
var temp__5757__auto___53633 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___53633 == null)){
} else {
var key_53634 = temp__5757__auto___53633;
(jsprops.key = key_53634);
}
...
var temp__5757__auto___53642 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___53642 == null)){
} else {
var key_53643 = temp__5757__auto___53642;
(jsprops.key = key_53643);
}
...
var temp__5757__auto___53651 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___53651 == null)){
} else {
var key_53653 = temp__5757__auto___53651;
(jsprops.key = key_53653);
}
...
var temp__5757__auto___53660 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___53660 == null)){
} else {
var key_53661 = temp__5757__auto___53660;
(jsprops.key = key_53661);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53563_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__53563_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__53566 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53566,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53566,(1),null);
...
break;
default:
var G__53675 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__53676 = compiler;
v = G__53675;
compiler = G__53676;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template53581 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template53581 = (function (opts,id,fn_to_element,parse_fn,meta53582){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template53581.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_53583,meta53582__$1){
var self__ = this;
var _53583__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template53581(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta53582__$1));
}));

(reagent.impl.template.t_reagent$impl$template53581.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_53583){
var self__ = this;
var _53583__$1 = this;
return self__.meta53582;
}));

(reagent.impl.template.t_reagent$impl$template53581.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template53581.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template53581.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template53581.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template53581.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template53581.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta53582","meta53582",-1227512639,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template53581.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template53581.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template53581");

(reagent.impl.template.t_reagent$impl$template53581.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template53581");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template53581.
 */
reagent.impl.template.__GT_t_reagent$impl$template53581 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template53581(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta53582){
return (new reagent.impl.template.t_reagent$impl$template53581(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta53582));
});

}

return (new reagent.impl.template.t_reagent$impl$template53581(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
