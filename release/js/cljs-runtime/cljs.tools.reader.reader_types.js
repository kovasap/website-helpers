...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_46890 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_46890(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_46899 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_46899(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_46904 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_46904(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_46905 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_46905(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_46916 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_46916(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_46928 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_46928(reader);
}
});
...
var G__46939 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__46940 = s.append(c);
c = G__46939;
s = G__46940;
continue;
}
