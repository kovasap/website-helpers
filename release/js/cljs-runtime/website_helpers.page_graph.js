...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,(function (){var iter__5523__auto__ = (function website_helpers$page_graph$get_category_links_$_iter__41460(s__41461){
return (new cljs.core.LazySeq(null,(function (){
var s__41461__$1 = s__41461;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__41461__$1);
if(temp__5825__auto__){
var s__41461__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__41461__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__41461__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__41463 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__41462 = (0);
while(true){
if((i__41462 < size__5522__auto__)){
var node = cljs.core._nth(c__5521__auto__,i__41462);
cljs.core.chunk_append(b__41463,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = ((function (i__41462,node,c__5521__auto__,size__5522__auto__,b__41463,s__41461__$2,temp__5825__auto__){
return (function website_helpers$page_graph$get_category_links_$_iter__41460_$_iter__41464(s__41465){
return (new cljs.core.LazySeq(null,((function (i__41462,node,c__5521__auto__,size__5522__auto__,b__41463,s__41461__$2,temp__5825__auto__){
return (function (){
var s__41465__$1 = s__41465;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__41465__$1);
if(temp__5825__auto____$1){
var s__41465__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__41465__$2)){
var c__5521__auto____$1 = cljs.core.chunk_first(s__41465__$2);
var size__5522__auto____$1 = cljs.core.count(c__5521__auto____$1);
var b__41467 = cljs.core.chunk_buffer(size__5522__auto____$1);
if((function (){var i__41466 = (0);
while(true){
if((i__41466 < size__5522__auto____$1)){
var category = cljs.core._nth(c__5521__auto____$1,i__41466);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
cljs.core.chunk_append(b__41467,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null));

var G__41512 = (i__41466 + (1));
i__41466 = G__41512;
continue;
} else {
var G__41513 = (i__41466 + (1));
i__41466 = G__41513;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__41467),website_helpers$page_graph$get_category_links_$_iter__41460_$_iter__41464(cljs.core.chunk_rest(s__41465__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__41467),null);
}
} else {
var category = cljs.core.first(s__41465__$2);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null),website_helpers$page_graph$get_category_links_$_iter__41460_$_iter__41464(cljs.core.rest(s__41465__$2)));
} else {
var G__41514 = cljs.core.rest(s__41465__$2);
s__41465__$1 = G__41514;
continue;
}
}
} else {
...
});})(i__41462,node,c__5521__auto__,size__5522__auto__,b__41463,s__41461__$2,temp__5825__auto__))
,null,null));
});})(i__41462,node,c__5521__auto__,size__5522__auto__,b__41463,s__41461__$2,temp__5825__auto__))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__41463),website_helpers$page_graph$get_category_links_$_iter__41460(cljs.core.chunk_rest(s__41461__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__41463),null);
}
} else {
var node = cljs.core.first(s__41461__$2);
return cljs.core.cons(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = ((function (node,s__41461__$2,temp__5825__auto__){
return (function website_helpers$page_graph$get_category_links_$_iter__41460_$_iter__41468(s__41469){
return (new cljs.core.LazySeq(null,(function (){
var s__41469__$1 = s__41469;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__41469__$1);
if(temp__5825__auto____$1){
var s__41469__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__41469__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__41469__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__41471 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__41470 = (0);
while(true){
if((i__41470 < size__5522__auto__)){
var category = cljs.core._nth(c__5521__auto__,i__41470);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
cljs.core.chunk_append(b__41471,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null));

var G__41516 = (i__41470 + (1));
i__41470 = G__41516;
continue;
} else {
var G__41517 = (i__41470 + (1));
i__41470 = G__41517;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__41471),website_helpers$page_graph$get_category_links_$_iter__41460_$_iter__41468(cljs.core.chunk_rest(s__41469__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__41471),null);
}
} else {
var category = cljs.core.first(s__41469__$2);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null),website_helpers$page_graph$get_category_links_$_iter__41460_$_iter__41468(cljs.core.rest(s__41469__$2)));
} else {
var G__41518 = cljs.core.rest(s__41469__$2);
s__41469__$1 = G__41518;
continue;
}
}
} else {
...
});})(node,s__41461__$2,temp__5825__auto__))
;
return iter__5523__auto__(new cljs.core.Keyword(null,"categories","categories",178386610).cljs$core$IFn$_invoke$arity$1(node));
})()),website_helpers$page_graph$get_category_links_$_iter__41460(cljs.core.rest(s__41461__$2)));
}
} else {
return null;
}
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = (function website_helpers$page_graph$iter__41474(s__41475){
return (new cljs.core.LazySeq(null,(function (){
var s__41475__$1 = s__41475;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__41475__$1);
if(temp__5825__auto__){
var s__41475__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__41475__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__41475__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__41477 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__41476 = (0);
while(true){
if((i__41476 < size__5522__auto__)){
var n = cljs.core._nth(c__5521__auto__,i__41476);
cljs.core.chunk_append(b__41477,(function (){var fexpr__41478 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.comp,update_fns);
return (fexpr__41478.cljs$core$IFn$_invoke$arity$1 ? fexpr__41478.cljs$core$IFn$_invoke$arity$1(n) : fexpr__41478.call(null,n));
})());

var G__41522 = (i__41476 + (1));
i__41476 = G__41522;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__41477),website_helpers$page_graph$iter__41474(cljs.core.chunk_rest(s__41475__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__41477),null);
}
} else {
var n = cljs.core.first(s__41475__$2);
return cljs.core.cons((function (){var fexpr__41479 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.comp,update_fns);
return (fexpr__41479.cljs$core$IFn$_invoke$arity$1 ? fexpr__41479.cljs$core$IFn$_invoke$arity$1(n) : fexpr__41479.call(null,n));
})(),website_helpers$page_graph$iter__41474(cljs.core.rest(s__41475__$2)));
}
} else {
return null;
}
...
/** @this {Function} */
(website_helpers.page_graph.update_nodes.cljs$lang$applyTo = (function (seq41472){
var G__41473 = cljs.core.first(seq41472);
var seq41472__$1 = cljs.core.next(seq41472);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41473,seq41472__$1);
}));

website_helpers.page_graph.scale_size = (function website_helpers$page_graph$scale_size(node){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"size","size",1098693007),(function (p1__41480_SHARP_){
if((p1__41480_SHARP_ == null)){
return (20);
} else {
return Math.sqrt((p1__41480_SHARP_ / (10)));
}
}));
});
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"name","name",1843675177),(function (p1__41481_SHARP_){
return cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__41481_SHARP_,/\./));
})),new cljs.core.Keyword(null,"path","path",-188191168),(function (p1__41482_SHARP_){
return clojure.string.replace(cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__41482_SHARP_,/\./)),/content\//,"");
})),new cljs.core.Keyword(null,"tree-path","tree-path",683503647),(function (p1__41483_SHARP_){
return cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__41483_SHARP_,/\./));
}));
}
});
website_helpers.page_graph.fix_path = (function website_helpers$page_graph$fix_path(node){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"tree-path","tree-path",683503647),(function (p1__41484_SHARP_){
return clojure.string.replace(p1__41484_SHARP_,/\/home/,"docs/");
}));
});
/**
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"name","name",1843675177),(function (p1__41485_SHARP_){
return website_helpers.page_graph.capitalize_words(clojure.string.replace(p1__41485_SHARP_,/-/," "));
}));
});
website_helpers.page_graph.index_categories = (function website_helpers$page_graph$index_categories(categories,num_notes){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5523__auto__ = (function website_helpers$page_graph$index_categories_$_iter__41486(s__41487){
return (new cljs.core.LazySeq(null,(function (){
...
var c__5521__auto__ = cljs.core.chunk_first(s__41487__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__41489 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__41488 = (0);
while(true){
if((i__41488 < size__5522__auto__)){
var vec__41490 = cljs.core._nth(c__5521__auto__,i__41488);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41490,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41490,(1),null);
cljs.core.chunk_append(b__41489,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [c,(num_notes + i)], null));

var G__41523 = (i__41488 + (1));
i__41488 = G__41523;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__41489),website_helpers$page_graph$index_categories_$_iter__41486(cljs.core.chunk_rest(s__41487__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__41489),null);
}
} else {
var vec__41493 = cljs.core.first(s__41487__$2);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41493,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41493,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [c,(num_notes + i)], null),website_helpers$page_graph$index_categories_$_iter__41486(cljs.core.rest(s__41487__$2)));
}
} else {
return null;
}
...
var most_mod_num = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.max,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41496_SHARP_){
return cljs.core.count(new cljs.core.Keyword(null,"modification-unix-timestamps","modification-unix-timestamps",653432816).cljs$core$IFn$_invoke$arity$1(p1__41496_SHARP_));
}),notes__$1));
var least_mod_num = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.min,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41497_SHARP_){
return cljs.core.count(new cljs.core.Keyword(null,"modification-unix-timestamps","modification-unix-timestamps",653432816).cljs$core$IFn$_invoke$arity$1(p1__41497_SHARP_));
}),notes__$1));
...
var ret__40881__auto__ = website_helpers.page_graph.update_nodes.cljs$core$IFn$_invoke$arity$variadic(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(idxed_notes,cljs.core.map.cljs$core$IFn$_invoke$arity$2(category_to_node,categories_to_idx)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([website_helpers.page_graph.prettify_name,website_helpers.page_graph.fix_path,website_helpers.page_graph.strip_extension,website_helpers.page_graph.scale_size,website_helpers.page_graph.assign_group,(function (p1__41498_SHARP_){
return website_helpers.page_graph.assign_opacity_mod(p1__41498_SHARP_,earliest_mod_time,latest_mod_time,categories);
}),(function (p1__41499_SHARP_){
return website_helpers.page_graph.assign_stroke_opacity_mod(p1__41499_SHARP_,least_mod_num,most_mod_num,categories);
}),(function (p1__41500_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__41500_SHARP_,new cljs.core.Keyword(null,"label","label",1718410804),cljs.core.first(new cljs.core.Keyword(null,"categories","categories",178386610).cljs$core$IFn$_invoke$arity$1(p1__41500_SHARP_)));
}),(function (p1__41501_SHARP_){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(p1__41501_SHARP_,new cljs.core.Keyword(null,"markdown","markdown",1227225089));
})], 0));
...
var ret__40881__auto__ = cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(website_helpers.page_graph.get_category_links(idxed_notes,idxed_categories),(function (){var iter__5523__auto__ = (function website_helpers$page_graph$notes_to_graph_$_iter__41502(s__41503){
return (new cljs.core.LazySeq(null,(function (){
var s__41503__$1 = s__41503;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__41503__$1);
if(temp__5825__auto__){
var s__41503__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__41503__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__41503__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__41505 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__41504 = (0);
while(true){
if((i__41504 < size__5522__auto__)){
var vec__41506 = cljs.core._nth(c__5521__auto__,i__41504);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41506,(0),null);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41506,(1),null);
cljs.core.chunk_append(b__41505,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),(0),new cljs.core.Keyword(null,"target","target",253001721),i,new cljs.core.Keyword(null,"value","value",305978217),(3)], null));

var G__41524 = (i__41504 + (1));
i__41504 = G__41524;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__41505),website_helpers$page_graph$notes_to_graph_$_iter__41502(cljs.core.chunk_rest(s__41503__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__41505),null);
}
} else {
var vec__41509 = cljs.core.first(s__41503__$2);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41509,(0),null);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41509,(1),null);
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),(0),new cljs.core.Keyword(null,"target","target",253001721),i,new cljs.core.Keyword(null,"value","value",305978217),(3)], null),website_helpers$page_graph$notes_to_graph_$_iter__41502(cljs.core.rest(s__41503__$2)));
}
} else {
return null;
}
