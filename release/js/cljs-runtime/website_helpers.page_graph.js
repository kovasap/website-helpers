...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,(function (){var iter__5523__auto__ = (function website_helpers$page_graph$get_category_links_$_iter__54532(s__54533){
return (new cljs.core.LazySeq(null,(function (){
var s__54533__$1 = s__54533;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__54533__$1);
if(temp__5825__auto__){
var s__54533__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__54533__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__54533__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__54535 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__54534 = (0);
while(true){
if((i__54534 < size__5522__auto__)){
var node = cljs.core._nth(c__5521__auto__,i__54534);
cljs.core.chunk_append(b__54535,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = ((function (i__54534,node,c__5521__auto__,size__5522__auto__,b__54535,s__54533__$2,temp__5825__auto__){
return (function website_helpers$page_graph$get_category_links_$_iter__54532_$_iter__54536(s__54537){
return (new cljs.core.LazySeq(null,((function (i__54534,node,c__5521__auto__,size__5522__auto__,b__54535,s__54533__$2,temp__5825__auto__){
return (function (){
var s__54537__$1 = s__54537;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__54537__$1);
if(temp__5825__auto____$1){
var s__54537__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__54537__$2)){
var c__5521__auto____$1 = cljs.core.chunk_first(s__54537__$2);
var size__5522__auto____$1 = cljs.core.count(c__5521__auto____$1);
var b__54539 = cljs.core.chunk_buffer(size__5522__auto____$1);
if((function (){var i__54538 = (0);
while(true){
if((i__54538 < size__5522__auto____$1)){
var category = cljs.core._nth(c__5521__auto____$1,i__54538);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
cljs.core.chunk_append(b__54539,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null));

var G__54585 = (i__54538 + (1));
i__54538 = G__54585;
continue;
} else {
var G__54586 = (i__54538 + (1));
i__54538 = G__54586;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__54539),website_helpers$page_graph$get_category_links_$_iter__54532_$_iter__54536(cljs.core.chunk_rest(s__54537__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__54539),null);
}
} else {
var category = cljs.core.first(s__54537__$2);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null),website_helpers$page_graph$get_category_links_$_iter__54532_$_iter__54536(cljs.core.rest(s__54537__$2)));
} else {
var G__54587 = cljs.core.rest(s__54537__$2);
s__54537__$1 = G__54587;
continue;
}
}
} else {
...
});})(i__54534,node,c__5521__auto__,size__5522__auto__,b__54535,s__54533__$2,temp__5825__auto__))
,null,null));
});})(i__54534,node,c__5521__auto__,size__5522__auto__,b__54535,s__54533__$2,temp__5825__auto__))
;
return iter__5523__auto__(cljs.core.first(cljs.core.sort.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"path-categories","path-categories",1155646784).cljs$core$IFn$_invoke$arity$1(node))));
})()));

var G__54588 = (i__54534 + (1));
i__54534 = G__54588;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__54535),website_helpers$page_graph$get_category_links_$_iter__54532(cljs.core.chunk_rest(s__54533__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__54535),null);
}
} else {
var node = cljs.core.first(s__54533__$2);
return cljs.core.cons(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = ((function (node,s__54533__$2,temp__5825__auto__){
return (function website_helpers$page_graph$get_category_links_$_iter__54532_$_iter__54540(s__54541){
return (new cljs.core.LazySeq(null,(function (){
var s__54541__$1 = s__54541;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__54541__$1);
if(temp__5825__auto____$1){
var s__54541__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__54541__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__54541__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__54543 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__54542 = (0);
while(true){
if((i__54542 < size__5522__auto__)){
var category = cljs.core._nth(c__5521__auto__,i__54542);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
cljs.core.chunk_append(b__54543,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null));

var G__54589 = (i__54542 + (1));
i__54542 = G__54589;
continue;
} else {
var G__54590 = (i__54542 + (1));
i__54542 = G__54590;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__54543),website_helpers$page_graph$get_category_links_$_iter__54532_$_iter__54540(cljs.core.chunk_rest(s__54541__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__54543),null);
}
} else {
var category = cljs.core.first(s__54541__$2);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null),website_helpers$page_graph$get_category_links_$_iter__54532_$_iter__54540(cljs.core.rest(s__54541__$2)));
} else {
var G__54591 = cljs.core.rest(s__54541__$2);
s__54541__$1 = G__54591;
continue;
}
}
} else {
...
});})(node,s__54533__$2,temp__5825__auto__))
;
return iter__5523__auto__(cljs.core.first(cljs.core.sort.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"path-categories","path-categories",1155646784).cljs$core$IFn$_invoke$arity$1(node))));
})()),website_helpers$page_graph$get_category_links_$_iter__54532(cljs.core.rest(s__54533__$2)));
}
} else {
return null;
}
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = (function website_helpers$page_graph$iter__54546(s__54547){
return (new cljs.core.LazySeq(null,(function (){
...
var n = cljs.core._nth(c__5521__auto__,i__54548);
cljs.core.chunk_append(b__54549,(function (){var fexpr__54550 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.comp,update_fns);
return (fexpr__54550.cljs$core$IFn$_invoke$arity$1 ? fexpr__54550.cljs$core$IFn$_invoke$arity$1(n) : fexpr__54550.call(null,n));
})());

var G__54595 = (i__54548 + (1));
i__54548 = G__54595;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__54549),website_helpers$page_graph$iter__54546(cljs.core.chunk_rest(s__54547__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__54549),null);
}
} else {
var n = cljs.core.first(s__54547__$2);
return cljs.core.cons((function (){var fexpr__54551 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.comp,update_fns);
return (fexpr__54551.cljs$core$IFn$_invoke$arity$1 ? fexpr__54551.cljs$core$IFn$_invoke$arity$1(n) : fexpr__54551.call(null,n));
})(),website_helpers$page_graph$iter__54546(cljs.core.rest(s__54547__$2)));
}
} else {
return null;
}
...
/** @this {Function} */
(website_helpers.page_graph.update_nodes.cljs$lang$applyTo = (function (seq54544){
var G__54545 = cljs.core.first(seq54544);
var seq54544__$1 = cljs.core.next(seq54544);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__54545,seq54544__$1);
}));

website_helpers.page_graph.scale_size = (function website_helpers$page_graph$scale_size(node){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"size","size",1098693007),(function (p1__54552_SHARP_){
if((p1__54552_SHARP_ == null)){
return (20);
} else {
return Math.sqrt((p1__54552_SHARP_ / (10)));
}
}));
});
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"name","name",1843675177),(function (p1__54553_SHARP_){
return cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__54553_SHARP_,/\./));
})),new cljs.core.Keyword(null,"path","path",-188191168),(function (p1__54554_SHARP_){
return clojure.string.replace(cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__54554_SHARP_,/\./)),/content\//,"");
})),new cljs.core.Keyword(null,"tree-path","tree-path",683503647),(function (p1__54555_SHARP_){
return cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__54555_SHARP_,/\./));
}));
}
});
website_helpers.page_graph.fix_path = (function website_helpers$page_graph$fix_path(node){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"tree-path","tree-path",683503647),(function (p1__54556_SHARP_){
return clojure.string.replace(p1__54556_SHARP_,/\/home/,"docs/");
}));
});
/**
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"name","name",1843675177),(function (p1__54557_SHARP_){
return website_helpers.page_graph.capitalize_words(clojure.string.replace(p1__54557_SHARP_,/-/," "));
}));
});
website_helpers.page_graph.index_categories = (function website_helpers$page_graph$index_categories(categories,num_notes){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5523__auto__ = (function website_helpers$page_graph$index_categories_$_iter__54558(s__54559){
return (new cljs.core.LazySeq(null,(function (){
var s__54559__$1 = s__54559;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__54559__$1);
if(temp__5825__auto__){
var s__54559__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__54559__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__54559__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__54561 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__54560 = (0);
while(true){
if((i__54560 < size__5522__auto__)){
var vec__54562 = cljs.core._nth(c__5521__auto__,i__54560);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54562,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54562,(1),null);
cljs.core.chunk_append(b__54561,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [c,(num_notes + i)], null));

var G__54596 = (i__54560 + (1));
i__54560 = G__54596;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__54561),website_helpers$page_graph$index_categories_$_iter__54558(cljs.core.chunk_rest(s__54559__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__54561),null);
}
} else {
var vec__54565 = cljs.core.first(s__54559__$2);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54565,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54565,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [c,(num_notes + i)], null),website_helpers$page_graph$index_categories_$_iter__54558(cljs.core.rest(s__54559__$2)));
}
} else {
return null;
}
...
var most_mod_num = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.max,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__54568_SHARP_){
return cljs.core.count(new cljs.core.Keyword(null,"modification-unix-timestamps","modification-unix-timestamps",653432816).cljs$core$IFn$_invoke$arity$1(p1__54568_SHARP_));
}),notes__$1));
var least_mod_num = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.min,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__54569_SHARP_){
return cljs.core.count(new cljs.core.Keyword(null,"modification-unix-timestamps","modification-unix-timestamps",653432816).cljs$core$IFn$_invoke$arity$1(p1__54569_SHARP_));
}),notes__$1));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__54578),website_helpers$page_graph$notes_to_graph_$_iter__54575(cljs.core.chunk_rest(s__54576__$2)));
} else {
...
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54582,(1),null);
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),(0),new cljs.core.Keyword(null,"target","target",253001721),i,new cljs.core.Keyword(null,"value","value",305978217),(3)], null),website_helpers$page_graph$notes_to_graph_$_iter__54575(cljs.core.rest(s__54576__$2)));
}
} else {
return null;
}
