...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,(function (){var iter__5523__auto__ = (function website_helpers$page_graph$get_category_links_$_iter__53117(s__53118){
return (new cljs.core.LazySeq(null,(function (){
var s__53118__$1 = s__53118;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__53118__$1);
if(temp__5825__auto__){
var s__53118__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__53118__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__53118__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__53120 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__53119 = (0);
while(true){
if((i__53119 < size__5522__auto__)){
var node = cljs.core._nth(c__5521__auto__,i__53119);
cljs.core.chunk_append(b__53120,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = ((function (i__53119,node,c__5521__auto__,size__5522__auto__,b__53120,s__53118__$2,temp__5825__auto__){
return (function website_helpers$page_graph$get_category_links_$_iter__53117_$_iter__53123(s__53124){
return (new cljs.core.LazySeq(null,((function (i__53119,node,c__5521__auto__,size__5522__auto__,b__53120,s__53118__$2,temp__5825__auto__){
return (function (){
var s__53124__$1 = s__53124;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__53124__$1);
if(temp__5825__auto____$1){
var s__53124__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__53124__$2)){
var c__5521__auto____$1 = cljs.core.chunk_first(s__53124__$2);
var size__5522__auto____$1 = cljs.core.count(c__5521__auto____$1);
var b__53126 = cljs.core.chunk_buffer(size__5522__auto____$1);
if((function (){var i__53125 = (0);
while(true){
if((i__53125 < size__5522__auto____$1)){
var category = cljs.core._nth(c__5521__auto____$1,i__53125);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
cljs.core.chunk_append(b__53126,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null));

var G__53185 = (i__53125 + (1));
i__53125 = G__53185;
continue;
} else {
var G__53186 = (i__53125 + (1));
i__53125 = G__53186;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__53126),website_helpers$page_graph$get_category_links_$_iter__53117_$_iter__53123(cljs.core.chunk_rest(s__53124__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__53126),null);
}
} else {
var category = cljs.core.first(s__53124__$2);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null),website_helpers$page_graph$get_category_links_$_iter__53117_$_iter__53123(cljs.core.rest(s__53124__$2)));
} else {
var G__53187 = cljs.core.rest(s__53124__$2);
s__53124__$1 = G__53187;
continue;
}
}
} else {
...
});})(i__53119,node,c__5521__auto__,size__5522__auto__,b__53120,s__53118__$2,temp__5825__auto__))
,null,null));
});})(i__53119,node,c__5521__auto__,size__5522__auto__,b__53120,s__53118__$2,temp__5825__auto__))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__53120),website_helpers$page_graph$get_category_links_$_iter__53117(cljs.core.chunk_rest(s__53118__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__53120),null);
}
} else {
var node = cljs.core.first(s__53118__$2);
return cljs.core.cons(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = ((function (node,s__53118__$2,temp__5825__auto__){
return (function website_helpers$page_graph$get_category_links_$_iter__53117_$_iter__53131(s__53132){
return (new cljs.core.LazySeq(null,(function (){
var s__53132__$1 = s__53132;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__53132__$1);
if(temp__5825__auto____$1){
var s__53132__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__53132__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__53132__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__53134 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__53133 = (0);
while(true){
if((i__53133 < size__5522__auto__)){
var category = cljs.core._nth(c__5521__auto__,i__53133);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
cljs.core.chunk_append(b__53134,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null));

var G__53189 = (i__53133 + (1));
i__53133 = G__53189;
continue;
} else {
var G__53190 = (i__53133 + (1));
i__53133 = G__53190;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__53134),website_helpers$page_graph$get_category_links_$_iter__53117_$_iter__53131(cljs.core.chunk_rest(s__53132__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__53134),null);
}
} else {
var category = cljs.core.first(s__53132__$2);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null),website_helpers$page_graph$get_category_links_$_iter__53117_$_iter__53131(cljs.core.rest(s__53132__$2)));
} else {
var G__53191 = cljs.core.rest(s__53132__$2);
s__53132__$1 = G__53191;
continue;
}
}
} else {
...
});})(node,s__53118__$2,temp__5825__auto__))
;
return iter__5523__auto__(new cljs.core.Keyword(null,"categories","categories",178386610).cljs$core$IFn$_invoke$arity$1(node));
})()),website_helpers$page_graph$get_category_links_$_iter__53117(cljs.core.rest(s__53118__$2)));
}
} else {
return null;
}
...
var len__5769__auto___53192 = arguments.length;
var i__5770__auto___53193 = (0);
while(true){
if((i__5770__auto___53193 < len__5769__auto___53192)){
args__5775__auto__.push((arguments[i__5770__auto___53193]));

var G__53194 = (i__5770__auto___53193 + (1));
i__5770__auto___53193 = G__53194;
continue;
} else {
}
break;
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = (function website_helpers$page_graph$iter__53144(s__53145){
return (new cljs.core.LazySeq(null,(function (){
var s__53145__$1 = s__53145;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__53145__$1);
if(temp__5825__auto__){
var s__53145__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__53145__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__53145__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__53148 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__53147 = (0);
while(true){
if((i__53147 < size__5522__auto__)){
var n = cljs.core._nth(c__5521__auto__,i__53147);
cljs.core.chunk_append(b__53148,(function (){var fexpr__53151 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.comp,update_fns);
return (fexpr__53151.cljs$core$IFn$_invoke$arity$1 ? fexpr__53151.cljs$core$IFn$_invoke$arity$1(n) : fexpr__53151.call(null,n));
})());

var G__53195 = (i__53147 + (1));
i__53147 = G__53195;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__53148),website_helpers$page_graph$iter__53144(cljs.core.chunk_rest(s__53145__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__53148),null);
}
} else {
var n = cljs.core.first(s__53145__$2);
return cljs.core.cons((function (){var fexpr__53152 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.comp,update_fns);
return (fexpr__53152.cljs$core$IFn$_invoke$arity$1 ? fexpr__53152.cljs$core$IFn$_invoke$arity$1(n) : fexpr__53152.call(null,n));
})(),website_helpers$page_graph$iter__53144(cljs.core.rest(s__53145__$2)));
}
} else {
return null;
}
...
/** @this {Function} */
(website_helpers.page_graph.update_nodes.cljs$lang$applyTo = (function (seq53138){
var G__53139 = cljs.core.first(seq53138);
var seq53138__$1 = cljs.core.next(seq53138);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__53139,seq53138__$1);
}));

website_helpers.page_graph.scale_size = (function website_helpers$page_graph$scale_size(node){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"size","size",1098693007),(function (p1__53153_SHARP_){
if((p1__53153_SHARP_ == null)){
return (20);
} else {
return Math.sqrt((p1__53153_SHARP_ / (10)));
}
}));
});
...
var least_mod_num = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.min,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53154_SHARP_){
return cljs.core.count(new cljs.core.Keyword(null,"modification-unix-timestamps","modification-unix-timestamps",653432816).cljs$core$IFn$_invoke$arity$1(p1__53154_SHARP_));
}),all_notes));
var most_mod_num = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.max,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53155_SHARP_){
return cljs.core.count(new cljs.core.Keyword(null,"modification-unix-timestamps","modification-unix-timestamps",653432816).cljs$core$IFn$_invoke$arity$1(p1__53155_SHARP_));
}),all_notes));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,clojure.set.intersection.cljs$core$IFn$_invoke$arity$2(categories_to_highlight,new cljs.core.Keyword(null,"categories","categories",178386610).cljs$core$IFn$_invoke$arity$1(node)))){
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"name","name",1843675177),(function (p1__53156_SHARP_){
return cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__53156_SHARP_,/\./));
})),new cljs.core.Keyword(null,"path","path",-188191168),(function (p1__53157_SHARP_){
return clojure.string.replace(cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__53157_SHARP_,/\./)),/content\//,"");
})),new cljs.core.Keyword(null,"tree-path","tree-path",683503647),(function (p1__53158_SHARP_){
return cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__53158_SHARP_,/\./));
}));
}
});
website_helpers.page_graph.fix_path = (function website_helpers$page_graph$fix_path(node){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"tree-path","tree-path",683503647),(function (p1__53159_SHARP_){
return clojure.string.replace(p1__53159_SHARP_,/\/home/,"docs/");
}));
});
/**
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"name","name",1843675177),(function (p1__53160_SHARP_){
return website_helpers.page_graph.capitalize_words(clojure.string.replace(p1__53160_SHARP_,/-/," "));
}));
});
website_helpers.page_graph.index_categories = (function website_helpers$page_graph$index_categories(categories,num_notes){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5523__auto__ = (function website_helpers$page_graph$index_categories_$_iter__53161(s__53162){
return (new cljs.core.LazySeq(null,(function (){
var s__53162__$1 = s__53162;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__53162__$1);
if(temp__5825__auto__){
var s__53162__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__53162__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__53162__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__53164 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__53163 = (0);
while(true){
if((i__53163 < size__5522__auto__)){
var vec__53165 = cljs.core._nth(c__5521__auto__,i__53163);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53165,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53165,(1),null);
cljs.core.chunk_append(b__53164,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [c,(num_notes + i)], null));

var G__53196 = (i__53163 + (1));
i__53163 = G__53196;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__53164),website_helpers$page_graph$index_categories_$_iter__53161(cljs.core.chunk_rest(s__53162__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__53164),null);
}
} else {
var vec__53168 = cljs.core.first(s__53162__$2);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53168,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53168,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [c,(num_notes + i)], null),website_helpers$page_graph$index_categories_$_iter__53161(cljs.core.rest(s__53162__$2)));
}
} else {
return null;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__53178),website_helpers$page_graph$notes_to_graph_$_iter__53175(cljs.core.chunk_rest(s__53176__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__53178),null);
}
} else {
var vec__53182 = cljs.core.first(s__53176__$2);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53182,(0),null);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53182,(1),null);
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),(0),new cljs.core.Keyword(null,"target","target",253001721),i,new cljs.core.Keyword(null,"value","value",305978217),(3)], null),website_helpers$page_graph$notes_to_graph_$_iter__53175(cljs.core.rest(s__53176__$2)));
}
} else {
return null;
}
