...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,(function (){var iter__5523__auto__ = (function website_helpers$page_graph$get_category_links_$_iter__41701(s__41702){
return (new cljs.core.LazySeq(null,(function (){
var s__41702__$1 = s__41702;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__41702__$1);
if(temp__5825__auto__){
var s__41702__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__41702__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__41702__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__41704 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__41703 = (0);
while(true){
if((i__41703 < size__5522__auto__)){
var node = cljs.core._nth(c__5521__auto__,i__41703);
cljs.core.chunk_append(b__41704,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = ((function (i__41703,node,c__5521__auto__,size__5522__auto__,b__41704,s__41702__$2,temp__5825__auto__){
return (function website_helpers$page_graph$get_category_links_$_iter__41701_$_iter__41707(s__41708){
return (new cljs.core.LazySeq(null,((function (i__41703,node,c__5521__auto__,size__5522__auto__,b__41704,s__41702__$2,temp__5825__auto__){
return (function (){
var s__41708__$1 = s__41708;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__41708__$1);
if(temp__5825__auto____$1){
var s__41708__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__41708__$2)){
var c__5521__auto____$1 = cljs.core.chunk_first(s__41708__$2);
var size__5522__auto____$1 = cljs.core.count(c__5521__auto____$1);
var b__41710 = cljs.core.chunk_buffer(size__5522__auto____$1);
if((function (){var i__41709 = (0);
while(true){
if((i__41709 < size__5522__auto____$1)){
var category = cljs.core._nth(c__5521__auto____$1,i__41709);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
cljs.core.chunk_append(b__41710,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null));

var G__41762 = (i__41709 + (1));
i__41709 = G__41762;
continue;
} else {
var G__41763 = (i__41709 + (1));
i__41709 = G__41763;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__41710),website_helpers$page_graph$get_category_links_$_iter__41701_$_iter__41707(cljs.core.chunk_rest(s__41708__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__41710),null);
}
} else {
var category = cljs.core.first(s__41708__$2);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null),website_helpers$page_graph$get_category_links_$_iter__41701_$_iter__41707(cljs.core.rest(s__41708__$2)));
} else {
var G__41764 = cljs.core.rest(s__41708__$2);
s__41708__$1 = G__41764;
continue;
}
}
} else {
...
});})(i__41703,node,c__5521__auto__,size__5522__auto__,b__41704,s__41702__$2,temp__5825__auto__))
,null,null));
});})(i__41703,node,c__5521__auto__,size__5522__auto__,b__41704,s__41702__$2,temp__5825__auto__))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__41704),website_helpers$page_graph$get_category_links_$_iter__41701(cljs.core.chunk_rest(s__41702__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__41704),null);
}
} else {
var node = cljs.core.first(s__41702__$2);
return cljs.core.cons(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = ((function (node,s__41702__$2,temp__5825__auto__){
return (function website_helpers$page_graph$get_category_links_$_iter__41701_$_iter__41713(s__41714){
return (new cljs.core.LazySeq(null,(function (){
var s__41714__$1 = s__41714;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__41714__$1);
if(temp__5825__auto____$1){
var s__41714__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__41714__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__41714__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__41716 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__41715 = (0);
while(true){
if((i__41715 < size__5522__auto__)){
var category = cljs.core._nth(c__5521__auto__,i__41715);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
cljs.core.chunk_append(b__41716,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null));

var G__41766 = (i__41715 + (1));
i__41715 = G__41766;
continue;
} else {
var G__41767 = (i__41715 + (1));
i__41715 = G__41767;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__41716),website_helpers$page_graph$get_category_links_$_iter__41701_$_iter__41713(cljs.core.chunk_rest(s__41714__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__41716),null);
}
} else {
var category = cljs.core.first(s__41714__$2);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null),website_helpers$page_graph$get_category_links_$_iter__41701_$_iter__41713(cljs.core.rest(s__41714__$2)));
} else {
var G__41768 = cljs.core.rest(s__41714__$2);
s__41714__$1 = G__41768;
continue;
}
}
} else {
...
});})(node,s__41702__$2,temp__5825__auto__))
;
return iter__5523__auto__(new cljs.core.Keyword(null,"categories","categories",178386610).cljs$core$IFn$_invoke$arity$1(node));
})()),website_helpers$page_graph$get_category_links_$_iter__41701(cljs.core.rest(s__41702__$2)));
}
} else {
return null;
}
...
var len__5769__auto___41769 = arguments.length;
var i__5770__auto___41770 = (0);
while(true){
if((i__5770__auto___41770 < len__5769__auto___41769)){
args__5775__auto__.push((arguments[i__5770__auto___41770]));

var G__41771 = (i__5770__auto___41770 + (1));
i__5770__auto___41770 = G__41771;
continue;
} else {
}
break;
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = (function website_helpers$page_graph$iter__41724(s__41725){
return (new cljs.core.LazySeq(null,(function (){
var s__41725__$1 = s__41725;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__41725__$1);
if(temp__5825__auto__){
var s__41725__$2 = temp__5825__auto__;
...
var n = cljs.core._nth(c__5521__auto__,i__41726);
cljs.core.chunk_append(b__41727,(function (){var fexpr__41728 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.comp,update_fns);
return (fexpr__41728.cljs$core$IFn$_invoke$arity$1 ? fexpr__41728.cljs$core$IFn$_invoke$arity$1(n) : fexpr__41728.call(null,n));
})());

var G__41772 = (i__41726 + (1));
i__41726 = G__41772;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__41727),website_helpers$page_graph$iter__41724(cljs.core.chunk_rest(s__41725__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__41727),null);
}
} else {
var n = cljs.core.first(s__41725__$2);
return cljs.core.cons((function (){var fexpr__41729 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.comp,update_fns);
return (fexpr__41729.cljs$core$IFn$_invoke$arity$1 ? fexpr__41729.cljs$core$IFn$_invoke$arity$1(n) : fexpr__41729.call(null,n));
})(),website_helpers$page_graph$iter__41724(cljs.core.rest(s__41725__$2)));
}
} else {
return null;
}
...
/** @this {Function} */
(website_helpers.page_graph.update_nodes.cljs$lang$applyTo = (function (seq41721){
var G__41722 = cljs.core.first(seq41721);
var seq41721__$1 = cljs.core.next(seq41721);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41722,seq41721__$1);
}));

website_helpers.page_graph.scale_size = (function website_helpers$page_graph$scale_size(node){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"size","size",1098693007),(function (p1__41730_SHARP_){
if((p1__41730_SHARP_ == null)){
return (20);
} else {
return Math.sqrt((p1__41730_SHARP_ / (10)));
}
}));
});
...
var least_mod_num = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.min,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41731_SHARP_){
return cljs.core.count(new cljs.core.Keyword(null,"modification-unix-timestamps","modification-unix-timestamps",653432816).cljs$core$IFn$_invoke$arity$1(p1__41731_SHARP_));
}),all_notes));
var most_mod_num = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.max,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41732_SHARP_){
return cljs.core.count(new cljs.core.Keyword(null,"modification-unix-timestamps","modification-unix-timestamps",653432816).cljs$core$IFn$_invoke$arity$1(p1__41732_SHARP_));
}),all_notes));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,clojure.set.intersection.cljs$core$IFn$_invoke$arity$2(categories_to_highlight,new cljs.core.Keyword(null,"categories","categories",178386610).cljs$core$IFn$_invoke$arity$1(node)))){
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"name","name",1843675177),(function (p1__41733_SHARP_){
return cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__41733_SHARP_,/\./));
})),new cljs.core.Keyword(null,"path","path",-188191168),(function (p1__41734_SHARP_){
return clojure.string.replace(cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__41734_SHARP_,/\./)),/content\//,"");
})),new cljs.core.Keyword(null,"tree-path","tree-path",683503647),(function (p1__41735_SHARP_){
return cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__41735_SHARP_,/\./));
}));
}
});
website_helpers.page_graph.fix_path = (function website_helpers$page_graph$fix_path(node){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"tree-path","tree-path",683503647),(function (p1__41736_SHARP_){
return clojure.string.replace(p1__41736_SHARP_,/\/home/,"docs/");
}));
});
/**
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"name","name",1843675177),(function (p1__41737_SHARP_){
return website_helpers.page_graph.capitalize_words(clojure.string.replace(p1__41737_SHARP_,/-/," "));
}));
});
website_helpers.page_graph.index_categories = (function website_helpers$page_graph$index_categories(categories,num_notes){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5523__auto__ = (function website_helpers$page_graph$index_categories_$_iter__41738(s__41739){
return (new cljs.core.LazySeq(null,(function (){
var s__41739__$1 = s__41739;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__41739__$1);
if(temp__5825__auto__){
var s__41739__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__41739__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__41739__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__41741 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__41740 = (0);
while(true){
if((i__41740 < size__5522__auto__)){
var vec__41742 = cljs.core._nth(c__5521__auto__,i__41740);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41742,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41742,(1),null);
cljs.core.chunk_append(b__41741,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [c,(num_notes + i)], null));

var G__41773 = (i__41740 + (1));
i__41740 = G__41773;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__41741),website_helpers$page_graph$index_categories_$_iter__41738(cljs.core.chunk_rest(s__41739__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__41741),null);
}
} else {
var vec__41745 = cljs.core.first(s__41739__$2);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41745,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41745,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [c,(num_notes + i)], null),website_helpers$page_graph$index_categories_$_iter__41738(cljs.core.rest(s__41739__$2)));
}
} else {
return null;
}
...
var c__5521__auto__ = cljs.core.chunk_first(s__41753__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__41755 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__41754 = (0);
while(true){
if((i__41754 < size__5522__auto__)){
var vec__41756 = cljs.core._nth(c__5521__auto__,i__41754);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41756,(0),null);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41756,(1),null);
cljs.core.chunk_append(b__41755,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),(0),new cljs.core.Keyword(null,"target","target",253001721),i,new cljs.core.Keyword(null,"value","value",305978217),(3)], null));

var G__41774 = (i__41754 + (1));
i__41754 = G__41774;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__41755),website_helpers$page_graph$notes_to_graph_$_iter__41752(cljs.core.chunk_rest(s__41753__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__41755),null);
}
} else {
var vec__41759 = cljs.core.first(s__41753__$2);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41759,(0),null);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41759,(1),null);
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),(0),new cljs.core.Keyword(null,"target","target",253001721),i,new cljs.core.Keyword(null,"value","value",305978217),(3)], null),website_helpers$page_graph$notes_to_graph_$_iter__41752(cljs.core.rest(s__41753__$2)));
}
} else {
return null;
}
