...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,(function (){var iter__5523__auto__ = (function website_helpers$page_graph$get_category_links_$_iter__25681(s__25682){
return (new cljs.core.LazySeq(null,(function (){
var s__25682__$1 = s__25682;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__25682__$1);
if(temp__5825__auto__){
var s__25682__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__25682__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__25682__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__25684 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__25683 = (0);
while(true){
if((i__25683 < size__5522__auto__)){
var node = cljs.core._nth(c__5521__auto__,i__25683);
cljs.core.chunk_append(b__25684,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = ((function (i__25683,node,c__5521__auto__,size__5522__auto__,b__25684,s__25682__$2,temp__5825__auto__){
return (function website_helpers$page_graph$get_category_links_$_iter__25681_$_iter__25685(s__25686){
return (new cljs.core.LazySeq(null,((function (i__25683,node,c__5521__auto__,size__5522__auto__,b__25684,s__25682__$2,temp__5825__auto__){
return (function (){
var s__25686__$1 = s__25686;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__25686__$1);
if(temp__5825__auto____$1){
var s__25686__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__25686__$2)){
var c__5521__auto____$1 = cljs.core.chunk_first(s__25686__$2);
var size__5522__auto____$1 = cljs.core.count(c__5521__auto____$1);
var b__25688 = cljs.core.chunk_buffer(size__5522__auto____$1);
if((function (){var i__25687 = (0);
while(true){
if((i__25687 < size__5522__auto____$1)){
var category = cljs.core._nth(c__5521__auto____$1,i__25687);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
cljs.core.chunk_append(b__25688,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null));

var G__25853 = (i__25687 + (1));
i__25687 = G__25853;
continue;
} else {
var G__25854 = (i__25687 + (1));
i__25687 = G__25854;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__25688),website_helpers$page_graph$get_category_links_$_iter__25681_$_iter__25685(cljs.core.chunk_rest(s__25686__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__25688),null);
}
} else {
var category = cljs.core.first(s__25686__$2);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null),website_helpers$page_graph$get_category_links_$_iter__25681_$_iter__25685(cljs.core.rest(s__25686__$2)));
} else {
var G__25855 = cljs.core.rest(s__25686__$2);
s__25686__$1 = G__25855;
continue;
}
}
} else {
...
});})(i__25683,node,c__5521__auto__,size__5522__auto__,b__25684,s__25682__$2,temp__5825__auto__))
,null,null));
});})(i__25683,node,c__5521__auto__,size__5522__auto__,b__25684,s__25682__$2,temp__5825__auto__))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__25684),website_helpers$page_graph$get_category_links_$_iter__25681(cljs.core.chunk_rest(s__25682__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__25684),null);
}
} else {
var node = cljs.core.first(s__25682__$2);
return cljs.core.cons(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = ((function (node,s__25682__$2,temp__5825__auto__){
return (function website_helpers$page_graph$get_category_links_$_iter__25681_$_iter__25689(s__25690){
return (new cljs.core.LazySeq(null,(function (){
var s__25690__$1 = s__25690;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__25690__$1);
if(temp__5825__auto____$1){
var s__25690__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__25690__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__25690__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__25692 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__25691 = (0);
while(true){
if((i__25691 < size__5522__auto__)){
var category = cljs.core._nth(c__5521__auto__,i__25691);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
cljs.core.chunk_append(b__25692,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null));

var G__25863 = (i__25691 + (1));
i__25691 = G__25863;
continue;
} else {
var G__25864 = (i__25691 + (1));
i__25691 = G__25864;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__25692),website_helpers$page_graph$get_category_links_$_iter__25681_$_iter__25689(cljs.core.chunk_rest(s__25690__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__25692),null);
}
} else {
var category = cljs.core.first(s__25690__$2);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null),website_helpers$page_graph$get_category_links_$_iter__25681_$_iter__25689(cljs.core.rest(s__25690__$2)));
} else {
var G__25868 = cljs.core.rest(s__25690__$2);
s__25690__$1 = G__25868;
continue;
}
}
} else {
...
});})(node,s__25682__$2,temp__5825__auto__))
;
return iter__5523__auto__(new cljs.core.Keyword(null,"categories","categories",178386610).cljs$core$IFn$_invoke$arity$1(node));
})()),website_helpers$page_graph$get_category_links_$_iter__25681(cljs.core.rest(s__25682__$2)));
}
} else {
return null;
}
...
args__5775__auto__.push((arguments[i__5770__auto___25874]));
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = (function website_helpers$page_graph$iter__25695(s__25696){
return (new cljs.core.LazySeq(null,(function (){
var s__25696__$1 = s__25696;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__25696__$1);
if(temp__5825__auto__){
var s__25696__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__25696__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__25696__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__25698 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__25697 = (0);
while(true){
if((i__25697 < size__5522__auto__)){
var n = cljs.core._nth(c__5521__auto__,i__25697);
cljs.core.chunk_append(b__25698,(function (){var fexpr__25699 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.comp,update_fns);
return (fexpr__25699.cljs$core$IFn$_invoke$arity$1 ? fexpr__25699.cljs$core$IFn$_invoke$arity$1(n) : fexpr__25699.call(null,n));
})());

var G__25880 = (i__25697 + (1));
i__25697 = G__25880;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__25698),website_helpers$page_graph$iter__25695(cljs.core.chunk_rest(s__25696__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__25698),null);
}
} else {
var n = cljs.core.first(s__25696__$2);
return cljs.core.cons((function (){var fexpr__25700 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.comp,update_fns);
return (fexpr__25700.cljs$core$IFn$_invoke$arity$1 ? fexpr__25700.cljs$core$IFn$_invoke$arity$1(n) : fexpr__25700.call(null,n));
})(),website_helpers$page_graph$iter__25695(cljs.core.rest(s__25696__$2)));
}
} else {
return null;
}
...
/** @this {Function} */
(website_helpers.page_graph.update_nodes.cljs$lang$applyTo = (function (seq25693){
var G__25694 = cljs.core.first(seq25693);
var seq25693__$1 = cljs.core.next(seq25693);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25694,seq25693__$1);
}));

website_helpers.page_graph.scale_size = (function website_helpers$page_graph$scale_size(node){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"size","size",1098693007),(function (p1__25701_SHARP_){
if((p1__25701_SHARP_ == null)){
return (20);
} else {
return Math.sqrt((p1__25701_SHARP_ / (10)));
}
}));
});
...
var least_mod_num = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.min,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__25702_SHARP_){
return cljs.core.count(new cljs.core.Keyword(null,"modification-unix-timestamps","modification-unix-timestamps",653432816).cljs$core$IFn$_invoke$arity$1(p1__25702_SHARP_));
}),all_notes));
var most_mod_num = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.max,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__25703_SHARP_){
return cljs.core.count(new cljs.core.Keyword(null,"modification-unix-timestamps","modification-unix-timestamps",653432816).cljs$core$IFn$_invoke$arity$1(p1__25703_SHARP_));
}),all_notes));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,clojure.set.intersection.cljs$core$IFn$_invoke$arity$2(categories_to_highlight,new cljs.core.Keyword(null,"categories","categories",178386610).cljs$core$IFn$_invoke$arity$1(node)))){
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"name","name",1843675177),(function (p1__25704_SHARP_){
return cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__25704_SHARP_,/\./));
})),new cljs.core.Keyword(null,"path","path",-188191168),(function (p1__25705_SHARP_){
return clojure.string.replace(cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__25705_SHARP_,/\./)),/content\//,"");
})),new cljs.core.Keyword(null,"tree-path","tree-path",683503647),(function (p1__25706_SHARP_){
return cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__25706_SHARP_,/\./));
}));
}
});
website_helpers.page_graph.fix_path = (function website_helpers$page_graph$fix_path(node){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"tree-path","tree-path",683503647),(function (p1__25713_SHARP_){
return clojure.string.replace(p1__25713_SHARP_,/\/home/,"docs/");
}));
});
/**
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"name","name",1843675177),(function (p1__25715_SHARP_){
return website_helpers.page_graph.capitalize_words(clojure.string.replace(p1__25715_SHARP_,/-/," "));
}));
});
website_helpers.page_graph.index_categories = (function website_helpers$page_graph$index_categories(categories,num_notes){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5523__auto__ = (function website_helpers$page_graph$index_categories_$_iter__25721(s__25722){
return (new cljs.core.LazySeq(null,(function (){
var s__25722__$1 = s__25722;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__25722__$1);
if(temp__5825__auto__){
var s__25722__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__25722__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__25722__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__25724 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__25723 = (0);
while(true){
if((i__25723 < size__5522__auto__)){
var vec__25732 = cljs.core._nth(c__5521__auto__,i__25723);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25732,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25732,(1),null);
cljs.core.chunk_append(b__25724,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [c,(num_notes + i)], null));

var G__25895 = (i__25723 + (1));
i__25723 = G__25895;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__25724),website_helpers$page_graph$index_categories_$_iter__25721(cljs.core.chunk_rest(s__25722__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__25724),null);
}
} else {
var vec__25736 = cljs.core.first(s__25722__$2);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25736,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25736,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [c,(num_notes + i)], null),website_helpers$page_graph$index_categories_$_iter__25721(cljs.core.rest(s__25722__$2)));
}
} else {
return null;
}
...
var vec__25793 = cljs.core._nth(c__5521__auto__,i__25780);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25793,(0),null);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25793,(1),null);
cljs.core.chunk_append(b__25781,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),(0),new cljs.core.Keyword(null,"target","target",253001721),i,new cljs.core.Keyword(null,"value","value",305978217),(3)], null));

var G__25914 = (i__25780 + (1));
i__25780 = G__25914;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__25781),website_helpers$page_graph$notes_to_graph_$_iter__25778(cljs.core.chunk_rest(s__25779__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__25781),null);
}
} else {
var vec__25801 = cljs.core.first(s__25779__$2);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25801,(0),null);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25801,(1),null);
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),(0),new cljs.core.Keyword(null,"target","target",253001721),i,new cljs.core.Keyword(null,"value","value",305978217),(3)], null),website_helpers$page_graph$notes_to_graph_$_iter__25778(cljs.core.rest(s__25779__$2)));
}
} else {
return null;
}
