...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,(function (){var iter__5523__auto__ = (function website_helpers$page_graph$get_category_links_$_iter__46933(s__46934){
return (new cljs.core.LazySeq(null,(function (){
var s__46934__$1 = s__46934;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__46934__$1);
if(temp__5825__auto__){
var s__46934__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__46934__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__46934__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__46936 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__46935 = (0);
while(true){
if((i__46935 < size__5522__auto__)){
var node = cljs.core._nth(c__5521__auto__,i__46935);
cljs.core.chunk_append(b__46936,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = ((function (i__46935,node,c__5521__auto__,size__5522__auto__,b__46936,s__46934__$2,temp__5825__auto__){
return (function website_helpers$page_graph$get_category_links_$_iter__46933_$_iter__46937(s__46938){
return (new cljs.core.LazySeq(null,((function (i__46935,node,c__5521__auto__,size__5522__auto__,b__46936,s__46934__$2,temp__5825__auto__){
return (function (){
var s__46938__$1 = s__46938;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__46938__$1);
if(temp__5825__auto____$1){
var s__46938__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__46938__$2)){
var c__5521__auto____$1 = cljs.core.chunk_first(s__46938__$2);
var size__5522__auto____$1 = cljs.core.count(c__5521__auto____$1);
var b__46940 = cljs.core.chunk_buffer(size__5522__auto____$1);
if((function (){var i__46939 = (0);
while(true){
if((i__46939 < size__5522__auto____$1)){
var category = cljs.core._nth(c__5521__auto____$1,i__46939);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
cljs.core.chunk_append(b__46940,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null));

var G__46985 = (i__46939 + (1));
i__46939 = G__46985;
continue;
} else {
var G__46986 = (i__46939 + (1));
i__46939 = G__46986;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__46940),website_helpers$page_graph$get_category_links_$_iter__46933_$_iter__46937(cljs.core.chunk_rest(s__46938__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__46940),null);
}
} else {
var category = cljs.core.first(s__46938__$2);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null),website_helpers$page_graph$get_category_links_$_iter__46933_$_iter__46937(cljs.core.rest(s__46938__$2)));
} else {
var G__46987 = cljs.core.rest(s__46938__$2);
s__46938__$1 = G__46987;
continue;
}
}
} else {
...
});})(i__46935,node,c__5521__auto__,size__5522__auto__,b__46936,s__46934__$2,temp__5825__auto__))
,null,null));
});})(i__46935,node,c__5521__auto__,size__5522__auto__,b__46936,s__46934__$2,temp__5825__auto__))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__46936),website_helpers$page_graph$get_category_links_$_iter__46933(cljs.core.chunk_rest(s__46934__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__46936),null);
}
} else {
var node = cljs.core.first(s__46934__$2);
return cljs.core.cons(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = ((function (node,s__46934__$2,temp__5825__auto__){
return (function website_helpers$page_graph$get_category_links_$_iter__46933_$_iter__46941(s__46942){
return (new cljs.core.LazySeq(null,(function (){
var s__46942__$1 = s__46942;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__46942__$1);
if(temp__5825__auto____$1){
var s__46942__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__46942__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__46942__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__46944 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__46943 = (0);
while(true){
if((i__46943 < size__5522__auto__)){
var category = cljs.core._nth(c__5521__auto__,i__46943);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
cljs.core.chunk_append(b__46944,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null));

var G__46989 = (i__46943 + (1));
i__46943 = G__46989;
continue;
} else {
var G__46990 = (i__46943 + (1));
i__46943 = G__46990;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__46944),website_helpers$page_graph$get_category_links_$_iter__46933_$_iter__46941(cljs.core.chunk_rest(s__46942__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__46944),null);
}
} else {
var category = cljs.core.first(s__46942__$2);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null),website_helpers$page_graph$get_category_links_$_iter__46933_$_iter__46941(cljs.core.rest(s__46942__$2)));
} else {
var G__46991 = cljs.core.rest(s__46942__$2);
s__46942__$1 = G__46991;
continue;
}
}
} else {
...
});})(node,s__46934__$2,temp__5825__auto__))
;
return iter__5523__auto__(new cljs.core.Keyword(null,"categories","categories",178386610).cljs$core$IFn$_invoke$arity$1(node));
})()),website_helpers$page_graph$get_category_links_$_iter__46933(cljs.core.rest(s__46934__$2)));
}
} else {
return null;
}
...
var len__5769__auto___46992 = arguments.length;
var i__5770__auto___46993 = (0);
while(true){
if((i__5770__auto___46993 < len__5769__auto___46992)){
args__5775__auto__.push((arguments[i__5770__auto___46993]));

var G__46994 = (i__5770__auto___46993 + (1));
i__5770__auto___46993 = G__46994;
continue;
} else {
}
break;
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = (function website_helpers$page_graph$iter__46947(s__46948){
return (new cljs.core.LazySeq(null,(function (){
var s__46948__$1 = s__46948;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__46948__$1);
if(temp__5825__auto__){
var s__46948__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__46948__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__46948__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__46950 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__46949 = (0);
while(true){
if((i__46949 < size__5522__auto__)){
var n = cljs.core._nth(c__5521__auto__,i__46949);
cljs.core.chunk_append(b__46950,(function (){var fexpr__46951 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.comp,update_fns);
return (fexpr__46951.cljs$core$IFn$_invoke$arity$1 ? fexpr__46951.cljs$core$IFn$_invoke$arity$1(n) : fexpr__46951.call(null,n));
})());

var G__46995 = (i__46949 + (1));
i__46949 = G__46995;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__46950),website_helpers$page_graph$iter__46947(cljs.core.chunk_rest(s__46948__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__46950),null);
}
} else {
var n = cljs.core.first(s__46948__$2);
return cljs.core.cons((function (){var fexpr__46952 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.comp,update_fns);
return (fexpr__46952.cljs$core$IFn$_invoke$arity$1 ? fexpr__46952.cljs$core$IFn$_invoke$arity$1(n) : fexpr__46952.call(null,n));
})(),website_helpers$page_graph$iter__46947(cljs.core.rest(s__46948__$2)));
}
} else {
return null;
}
...
/** @this {Function} */
(website_helpers.page_graph.update_nodes.cljs$lang$applyTo = (function (seq46945){
var G__46946 = cljs.core.first(seq46945);
var seq46945__$1 = cljs.core.next(seq46945);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46946,seq46945__$1);
}));

website_helpers.page_graph.scale_size = (function website_helpers$page_graph$scale_size(node){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"size","size",1098693007),(function (p1__46953_SHARP_){
if((p1__46953_SHARP_ == null)){
return (20);
} else {
return Math.sqrt((p1__46953_SHARP_ / (10)));
}
}));
});
...
var least_mod_num = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.min,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46954_SHARP_){
return cljs.core.count(new cljs.core.Keyword(null,"modification-unix-timestamps","modification-unix-timestamps",653432816).cljs$core$IFn$_invoke$arity$1(p1__46954_SHARP_));
}),all_notes));
var most_mod_num = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.max,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46955_SHARP_){
return cljs.core.count(new cljs.core.Keyword(null,"modification-unix-timestamps","modification-unix-timestamps",653432816).cljs$core$IFn$_invoke$arity$1(p1__46955_SHARP_));
}),all_notes));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,clojure.set.intersection.cljs$core$IFn$_invoke$arity$2(categories_to_highlight,new cljs.core.Keyword(null,"categories","categories",178386610).cljs$core$IFn$_invoke$arity$1(node)))){
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"name","name",1843675177),(function (p1__46956_SHARP_){
return cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__46956_SHARP_,/\./));
})),new cljs.core.Keyword(null,"path","path",-188191168),(function (p1__46957_SHARP_){
return clojure.string.replace(cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__46957_SHARP_,/\./)),/content\//,"");
})),new cljs.core.Keyword(null,"tree-path","tree-path",683503647),(function (p1__46958_SHARP_){
return cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__46958_SHARP_,/\./));
}));
}
});
website_helpers.page_graph.fix_path = (function website_helpers$page_graph$fix_path(node){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"tree-path","tree-path",683503647),(function (p1__46959_SHARP_){
return clojure.string.replace(p1__46959_SHARP_,/\/home/,"docs/");
}));
});
/**
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"name","name",1843675177),(function (p1__46960_SHARP_){
return website_helpers.page_graph.capitalize_words(clojure.string.replace(p1__46960_SHARP_,/-/," "));
}));
});
website_helpers.page_graph.index_categories = (function website_helpers$page_graph$index_categories(categories,num_notes){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5523__auto__ = (function website_helpers$page_graph$index_categories_$_iter__46961(s__46962){
return (new cljs.core.LazySeq(null,(function (){
var s__46962__$1 = s__46962;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__46962__$1);
if(temp__5825__auto__){
var s__46962__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__46962__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__46962__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__46964 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__46963 = (0);
while(true){
if((i__46963 < size__5522__auto__)){
var vec__46965 = cljs.core._nth(c__5521__auto__,i__46963);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46965,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46965,(1),null);
cljs.core.chunk_append(b__46964,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [c,(num_notes + i)], null));

var G__46996 = (i__46963 + (1));
i__46963 = G__46996;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__46964),website_helpers$page_graph$index_categories_$_iter__46961(cljs.core.chunk_rest(s__46962__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__46964),null);
}
} else {
var vec__46968 = cljs.core.first(s__46962__$2);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46968,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46968,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [c,(num_notes + i)], null),website_helpers$page_graph$index_categories_$_iter__46961(cljs.core.rest(s__46962__$2)));
}
} else {
return null;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__46978),website_helpers$page_graph$notes_to_graph_$_iter__46975(cljs.core.chunk_rest(s__46976__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__46978),null);
}
} else {
var vec__46982 = cljs.core.first(s__46976__$2);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46982,(0),null);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46982,(1),null);
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),(0),new cljs.core.Keyword(null,"target","target",253001721),i,new cljs.core.Keyword(null,"value","value",305978217),(3)], null),website_helpers$page_graph$notes_to_graph_$_iter__46975(cljs.core.rest(s__46976__$2)));
}
} else {
return null;
}
