...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,(function (){var iter__5523__auto__ = (function website_helpers$page_graph$get_category_links_$_iter__49505(s__49506){
return (new cljs.core.LazySeq(null,(function (){
var s__49506__$1 = s__49506;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__49506__$1);
if(temp__5825__auto__){
var s__49506__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__49506__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__49506__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__49508 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__49507 = (0);
while(true){
if((i__49507 < size__5522__auto__)){
var node = cljs.core._nth(c__5521__auto__,i__49507);
cljs.core.chunk_append(b__49508,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = ((function (i__49507,node,c__5521__auto__,size__5522__auto__,b__49508,s__49506__$2,temp__5825__auto__){
return (function website_helpers$page_graph$get_category_links_$_iter__49505_$_iter__49511(s__49512){
return (new cljs.core.LazySeq(null,((function (i__49507,node,c__5521__auto__,size__5522__auto__,b__49508,s__49506__$2,temp__5825__auto__){
return (function (){
var s__49512__$1 = s__49512;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__49512__$1);
if(temp__5825__auto____$1){
var s__49512__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__49512__$2)){
var c__5521__auto____$1 = cljs.core.chunk_first(s__49512__$2);
var size__5522__auto____$1 = cljs.core.count(c__5521__auto____$1);
var b__49514 = cljs.core.chunk_buffer(size__5522__auto____$1);
if((function (){var i__49513 = (0);
while(true){
if((i__49513 < size__5522__auto____$1)){
var category = cljs.core._nth(c__5521__auto____$1,i__49513);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
cljs.core.chunk_append(b__49514,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null));

var G__49583 = (i__49513 + (1));
i__49513 = G__49583;
continue;
} else {
var G__49584 = (i__49513 + (1));
i__49513 = G__49584;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__49514),website_helpers$page_graph$get_category_links_$_iter__49505_$_iter__49511(cljs.core.chunk_rest(s__49512__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__49514),null);
}
} else {
var category = cljs.core.first(s__49512__$2);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null),website_helpers$page_graph$get_category_links_$_iter__49505_$_iter__49511(cljs.core.rest(s__49512__$2)));
} else {
var G__49585 = cljs.core.rest(s__49512__$2);
s__49512__$1 = G__49585;
continue;
}
}
} else {
...
});})(i__49507,node,c__5521__auto__,size__5522__auto__,b__49508,s__49506__$2,temp__5825__auto__))
,null,null));
});})(i__49507,node,c__5521__auto__,size__5522__auto__,b__49508,s__49506__$2,temp__5825__auto__))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__49508),website_helpers$page_graph$get_category_links_$_iter__49505(cljs.core.chunk_rest(s__49506__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__49508),null);
}
} else {
var node = cljs.core.first(s__49506__$2);
return cljs.core.cons(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = ((function (node,s__49506__$2,temp__5825__auto__){
return (function website_helpers$page_graph$get_category_links_$_iter__49505_$_iter__49519(s__49520){
return (new cljs.core.LazySeq(null,(function (){
var s__49520__$1 = s__49520;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__49520__$1);
if(temp__5825__auto____$1){
var s__49520__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__49520__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__49520__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__49522 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__49521 = (0);
while(true){
if((i__49521 < size__5522__auto__)){
var category = cljs.core._nth(c__5521__auto__,i__49521);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
cljs.core.chunk_append(b__49522,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null));

var G__49587 = (i__49521 + (1));
i__49521 = G__49587;
continue;
} else {
var G__49588 = (i__49521 + (1));
i__49521 = G__49588;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__49522),website_helpers$page_graph$get_category_links_$_iter__49505_$_iter__49519(cljs.core.chunk_rest(s__49520__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__49522),null);
}
} else {
var category = cljs.core.first(s__49520__$2);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null),website_helpers$page_graph$get_category_links_$_iter__49505_$_iter__49519(cljs.core.rest(s__49520__$2)));
} else {
var G__49589 = cljs.core.rest(s__49520__$2);
s__49520__$1 = G__49589;
continue;
}
}
} else {
...
});})(node,s__49506__$2,temp__5825__auto__))
;
return iter__5523__auto__(new cljs.core.Keyword(null,"categories","categories",178386610).cljs$core$IFn$_invoke$arity$1(node));
})()),website_helpers$page_graph$get_category_links_$_iter__49505(cljs.core.rest(s__49506__$2)));
}
} else {
return null;
}
...
var len__5769__auto___49590 = arguments.length;
var i__5770__auto___49591 = (0);
while(true){
if((i__5770__auto___49591 < len__5769__auto___49590)){
args__5775__auto__.push((arguments[i__5770__auto___49591]));

var G__49592 = (i__5770__auto___49591 + (1));
i__5770__auto___49591 = G__49592;
continue;
} else {
}
break;
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = (function website_helpers$page_graph$iter__49533(s__49534){
return (new cljs.core.LazySeq(null,(function (){
var s__49534__$1 = s__49534;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__49534__$1);
if(temp__5825__auto__){
var s__49534__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__49534__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__49534__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__49536 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__49535 = (0);
while(true){
if((i__49535 < size__5522__auto__)){
var n = cljs.core._nth(c__5521__auto__,i__49535);
cljs.core.chunk_append(b__49536,(function (){var fexpr__49538 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.comp,update_fns);
return (fexpr__49538.cljs$core$IFn$_invoke$arity$1 ? fexpr__49538.cljs$core$IFn$_invoke$arity$1(n) : fexpr__49538.call(null,n));
})());

var G__49593 = (i__49535 + (1));
i__49535 = G__49593;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__49536),website_helpers$page_graph$iter__49533(cljs.core.chunk_rest(s__49534__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__49536),null);
}
} else {
var n = cljs.core.first(s__49534__$2);
return cljs.core.cons((function (){var fexpr__49539 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.comp,update_fns);
return (fexpr__49539.cljs$core$IFn$_invoke$arity$1 ? fexpr__49539.cljs$core$IFn$_invoke$arity$1(n) : fexpr__49539.call(null,n));
})(),website_helpers$page_graph$iter__49533(cljs.core.rest(s__49534__$2)));
}
} else {
return null;
}
...
/** @this {Function} */
(website_helpers.page_graph.update_nodes.cljs$lang$applyTo = (function (seq49529){
var G__49530 = cljs.core.first(seq49529);
var seq49529__$1 = cljs.core.next(seq49529);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49530,seq49529__$1);
}));

website_helpers.page_graph.scale_size = (function website_helpers$page_graph$scale_size(node){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"size","size",1098693007),(function (p1__49546_SHARP_){
if((p1__49546_SHARP_ == null)){
return (20);
} else {
return Math.sqrt((p1__49546_SHARP_ / (10)));
}
}));
});
...
var least_mod_num = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.min,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49548_SHARP_){
return cljs.core.count(new cljs.core.Keyword(null,"modification-unix-timestamps","modification-unix-timestamps",653432816).cljs$core$IFn$_invoke$arity$1(p1__49548_SHARP_));
}),all_notes));
var most_mod_num = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.max,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49549_SHARP_){
return cljs.core.count(new cljs.core.Keyword(null,"modification-unix-timestamps","modification-unix-timestamps",653432816).cljs$core$IFn$_invoke$arity$1(p1__49549_SHARP_));
}),all_notes));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,clojure.set.intersection.cljs$core$IFn$_invoke$arity$2(categories_to_highlight,new cljs.core.Keyword(null,"categories","categories",178386610).cljs$core$IFn$_invoke$arity$1(node)))){
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"name","name",1843675177),(function (p1__49553_SHARP_){
return cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__49553_SHARP_,/\./));
})),new cljs.core.Keyword(null,"path","path",-188191168),(function (p1__49554_SHARP_){
return clojure.string.replace(cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__49554_SHARP_,/\./)),/content\//,"");
})),new cljs.core.Keyword(null,"tree-path","tree-path",683503647),(function (p1__49555_SHARP_){
return cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__49555_SHARP_,/\./));
}));
}
});
website_helpers.page_graph.fix_path = (function website_helpers$page_graph$fix_path(node){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"tree-path","tree-path",683503647),(function (p1__49557_SHARP_){
return clojure.string.replace(p1__49557_SHARP_,/\/home/,"docs/");
}));
});
/**
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"name","name",1843675177),(function (p1__49558_SHARP_){
return website_helpers.page_graph.capitalize_words(clojure.string.replace(p1__49558_SHARP_,/-/," "));
}));
});
website_helpers.page_graph.index_categories = (function website_helpers$page_graph$index_categories(categories,num_notes){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5523__auto__ = (function website_helpers$page_graph$index_categories_$_iter__49559(s__49560){
return (new cljs.core.LazySeq(null,(function (){
var s__49560__$1 = s__49560;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__49560__$1);
if(temp__5825__auto__){
var s__49560__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__49560__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__49560__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__49562 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__49561 = (0);
while(true){
if((i__49561 < size__5522__auto__)){
var vec__49563 = cljs.core._nth(c__5521__auto__,i__49561);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49563,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49563,(1),null);
cljs.core.chunk_append(b__49562,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [c,(num_notes + i)], null));

var G__49594 = (i__49561 + (1));
i__49561 = G__49594;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__49562),website_helpers$page_graph$index_categories_$_iter__49559(cljs.core.chunk_rest(s__49560__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__49562),null);
}
} else {
var vec__49566 = cljs.core.first(s__49560__$2);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49566,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49566,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [c,(num_notes + i)], null),website_helpers$page_graph$index_categories_$_iter__49559(cljs.core.rest(s__49560__$2)));
}
} else {
return null;
}
...
var c__5521__auto__ = cljs.core.chunk_first(s__49574__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__49576 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__49575 = (0);
while(true){
if((i__49575 < size__5522__auto__)){
var vec__49577 = cljs.core._nth(c__5521__auto__,i__49575);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49577,(0),null);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49577,(1),null);
cljs.core.chunk_append(b__49576,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),(0),new cljs.core.Keyword(null,"target","target",253001721),i,new cljs.core.Keyword(null,"value","value",305978217),(3)], null));

var G__49595 = (i__49575 + (1));
i__49575 = G__49595;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__49576),website_helpers$page_graph$notes_to_graph_$_iter__49573(cljs.core.chunk_rest(s__49574__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__49576),null);
}
} else {
var vec__49580 = cljs.core.first(s__49574__$2);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49580,(0),null);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49580,(1),null);
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),(0),new cljs.core.Keyword(null,"target","target",253001721),i,new cljs.core.Keyword(null,"value","value",305978217),(3)], null),website_helpers$page_graph$notes_to_graph_$_iter__49573(cljs.core.rest(s__49574__$2)));
}
} else {
return null;
}
