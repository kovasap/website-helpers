...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,(function (){var iter__5523__auto__ = (function website_helpers$page_graph$get_category_links_$_iter__42023(s__42024){
return (new cljs.core.LazySeq(null,(function (){
var s__42024__$1 = s__42024;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__42024__$1);
if(temp__5825__auto__){
var s__42024__$2 = temp__5825__auto__;
...
var node = cljs.core._nth(c__5521__auto__,i__42025);
cljs.core.chunk_append(b__42026,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = ((function (i__42025,node,c__5521__auto__,size__5522__auto__,b__42026,s__42024__$2,temp__5825__auto__){
return (function website_helpers$page_graph$get_category_links_$_iter__42023_$_iter__42027(s__42028){
return (new cljs.core.LazySeq(null,((function (i__42025,node,c__5521__auto__,size__5522__auto__,b__42026,s__42024__$2,temp__5825__auto__){
return (function (){
var s__42028__$1 = s__42028;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__42028__$1);
if(temp__5825__auto____$1){
var s__42028__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__42028__$2)){
var c__5521__auto____$1 = cljs.core.chunk_first(s__42028__$2);
var size__5522__auto____$1 = cljs.core.count(c__5521__auto____$1);
var b__42030 = cljs.core.chunk_buffer(size__5522__auto____$1);
if((function (){var i__42029 = (0);
while(true){
if((i__42029 < size__5522__auto____$1)){
var category = cljs.core._nth(c__5521__auto____$1,i__42029);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
cljs.core.chunk_append(b__42030,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null));

var G__42075 = (i__42029 + (1));
i__42029 = G__42075;
continue;
} else {
var G__42076 = (i__42029 + (1));
i__42029 = G__42076;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__42030),website_helpers$page_graph$get_category_links_$_iter__42023_$_iter__42027(cljs.core.chunk_rest(s__42028__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__42030),null);
}
} else {
var category = cljs.core.first(s__42028__$2);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null),website_helpers$page_graph$get_category_links_$_iter__42023_$_iter__42027(cljs.core.rest(s__42028__$2)));
} else {
var G__42077 = cljs.core.rest(s__42028__$2);
s__42028__$1 = G__42077;
continue;
}
}
} else {
...
});})(i__42025,node,c__5521__auto__,size__5522__auto__,b__42026,s__42024__$2,temp__5825__auto__))
,null,null));
});})(i__42025,node,c__5521__auto__,size__5522__auto__,b__42026,s__42024__$2,temp__5825__auto__))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__42026),website_helpers$page_graph$get_category_links_$_iter__42023(cljs.core.chunk_rest(s__42024__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__42026),null);
}
} else {
var node = cljs.core.first(s__42024__$2);
return cljs.core.cons(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = ((function (node,s__42024__$2,temp__5825__auto__){
return (function website_helpers$page_graph$get_category_links_$_iter__42023_$_iter__42031(s__42032){
return (new cljs.core.LazySeq(null,(function (){
var s__42032__$1 = s__42032;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__42032__$1);
if(temp__5825__auto____$1){
var s__42032__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__42032__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__42032__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__42034 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__42033 = (0);
while(true){
if((i__42033 < size__5522__auto__)){
var category = cljs.core._nth(c__5521__auto__,i__42033);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
cljs.core.chunk_append(b__42034,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null));

var G__42079 = (i__42033 + (1));
i__42033 = G__42079;
continue;
} else {
var G__42080 = (i__42033 + (1));
i__42033 = G__42080;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__42034),website_helpers$page_graph$get_category_links_$_iter__42023_$_iter__42031(cljs.core.chunk_rest(s__42032__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__42034),null);
}
} else {
var category = cljs.core.first(s__42032__$2);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null),website_helpers$page_graph$get_category_links_$_iter__42023_$_iter__42031(cljs.core.rest(s__42032__$2)));
} else {
var G__42081 = cljs.core.rest(s__42032__$2);
s__42032__$1 = G__42081;
continue;
}
}
} else {
...
});})(node,s__42024__$2,temp__5825__auto__))
;
return iter__5523__auto__(new cljs.core.Keyword(null,"categories","categories",178386610).cljs$core$IFn$_invoke$arity$1(node));
})()),website_helpers$page_graph$get_category_links_$_iter__42023(cljs.core.rest(s__42024__$2)));
}
} else {
return null;
}
...
var len__5769__auto___42082 = arguments.length;
var i__5770__auto___42083 = (0);
while(true){
if((i__5770__auto___42083 < len__5769__auto___42082)){
args__5775__auto__.push((arguments[i__5770__auto___42083]));

var G__42084 = (i__5770__auto___42083 + (1));
i__5770__auto___42083 = G__42084;
continue;
} else {
}
break;
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = (function website_helpers$page_graph$iter__42037(s__42038){
return (new cljs.core.LazySeq(null,(function (){
var s__42038__$1 = s__42038;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__42038__$1);
if(temp__5825__auto__){
var s__42038__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__42038__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__42038__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__42040 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__42039 = (0);
while(true){
if((i__42039 < size__5522__auto__)){
var n = cljs.core._nth(c__5521__auto__,i__42039);
cljs.core.chunk_append(b__42040,(function (){var fexpr__42041 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.comp,update_fns);
return (fexpr__42041.cljs$core$IFn$_invoke$arity$1 ? fexpr__42041.cljs$core$IFn$_invoke$arity$1(n) : fexpr__42041.call(null,n));
})());

var G__42085 = (i__42039 + (1));
i__42039 = G__42085;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__42040),website_helpers$page_graph$iter__42037(cljs.core.chunk_rest(s__42038__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__42040),null);
}
} else {
var n = cljs.core.first(s__42038__$2);
return cljs.core.cons((function (){var fexpr__42042 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.comp,update_fns);
return (fexpr__42042.cljs$core$IFn$_invoke$arity$1 ? fexpr__42042.cljs$core$IFn$_invoke$arity$1(n) : fexpr__42042.call(null,n));
})(),website_helpers$page_graph$iter__42037(cljs.core.rest(s__42038__$2)));
}
} else {
return null;
}
...
/** @this {Function} */
(website_helpers.page_graph.update_nodes.cljs$lang$applyTo = (function (seq42035){
var G__42036 = cljs.core.first(seq42035);
var seq42035__$1 = cljs.core.next(seq42035);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42036,seq42035__$1);
}));

website_helpers.page_graph.scale_size = (function website_helpers$page_graph$scale_size(node){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"size","size",1098693007),(function (p1__42043_SHARP_){
if((p1__42043_SHARP_ == null)){
return (20);
} else {
return Math.sqrt((p1__42043_SHARP_ / (10)));
}
}));
});
...
var least_mod_num = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.min,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42044_SHARP_){
return cljs.core.count(new cljs.core.Keyword(null,"modification-unix-timestamps","modification-unix-timestamps",653432816).cljs$core$IFn$_invoke$arity$1(p1__42044_SHARP_));
}),all_notes));
var most_mod_num = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.max,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42045_SHARP_){
return cljs.core.count(new cljs.core.Keyword(null,"modification-unix-timestamps","modification-unix-timestamps",653432816).cljs$core$IFn$_invoke$arity$1(p1__42045_SHARP_));
}),all_notes));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,clojure.set.intersection.cljs$core$IFn$_invoke$arity$2(categories_to_highlight,new cljs.core.Keyword(null,"categories","categories",178386610).cljs$core$IFn$_invoke$arity$1(node)))){
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"name","name",1843675177),(function (p1__42046_SHARP_){
return cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__42046_SHARP_,/\./));
})),new cljs.core.Keyword(null,"path","path",-188191168),(function (p1__42047_SHARP_){
return clojure.string.replace(cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__42047_SHARP_,/\./)),/content\//,"");
})),new cljs.core.Keyword(null,"tree-path","tree-path",683503647),(function (p1__42048_SHARP_){
return cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__42048_SHARP_,/\./));
}));
}
});
website_helpers.page_graph.fix_path = (function website_helpers$page_graph$fix_path(node){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"tree-path","tree-path",683503647),(function (p1__42049_SHARP_){
return clojure.string.replace(p1__42049_SHARP_,/\/home/,"docs/");
}));
});
/**
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"name","name",1843675177),(function (p1__42050_SHARP_){
return website_helpers.page_graph.capitalize_words(clojure.string.replace(p1__42050_SHARP_,/-/," "));
}));
});
website_helpers.page_graph.index_categories = (function website_helpers$page_graph$index_categories(categories,num_notes){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5523__auto__ = (function website_helpers$page_graph$index_categories_$_iter__42051(s__42052){
return (new cljs.core.LazySeq(null,(function (){
var s__42052__$1 = s__42052;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__42052__$1);
if(temp__5825__auto__){
var s__42052__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__42052__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__42052__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__42054 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__42053 = (0);
while(true){
if((i__42053 < size__5522__auto__)){
var vec__42055 = cljs.core._nth(c__5521__auto__,i__42053);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42055,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42055,(1),null);
cljs.core.chunk_append(b__42054,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [c,(num_notes + i)], null));

var G__42086 = (i__42053 + (1));
i__42053 = G__42086;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__42054),website_helpers$page_graph$index_categories_$_iter__42051(cljs.core.chunk_rest(s__42052__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__42054),null);
}
} else {
var vec__42058 = cljs.core.first(s__42052__$2);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42058,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42058,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [c,(num_notes + i)], null),website_helpers$page_graph$index_categories_$_iter__42051(cljs.core.rest(s__42052__$2)));
}
} else {
return null;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__42068),website_helpers$page_graph$notes_to_graph_$_iter__42065(cljs.core.chunk_rest(s__42066__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__42068),null);
}
} else {
var vec__42072 = cljs.core.first(s__42066__$2);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42072,(0),null);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42072,(1),null);
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),(0),new cljs.core.Keyword(null,"target","target",253001721),i,new cljs.core.Keyword(null,"value","value",305978217),(3)], null),website_helpers$page_graph$notes_to_graph_$_iter__42065(cljs.core.rest(s__42066__$2)));
}
} else {
return null;
}
