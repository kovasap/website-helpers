...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h3","h3",2067611163),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(title),": "].join('')], null),(((links == null))?"":cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul","ul",-1349521403)], null),(function (){var iter__5523__auto__ = (function website_helpers$hyperlink_lists$link_list_$_iter__46315(s__46316){
return (new cljs.core.LazySeq(null,(function (){
var s__46316__$1 = s__46316;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__46316__$1);
if(temp__5825__auto__){
var s__46316__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__46316__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__46316__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__46318 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__46317 = (0);
while(true){
if((i__46317 < size__5522__auto__)){
var link = cljs.core._nth(c__5521__auto__,i__46317);
cljs.core.chunk_append(b__46318,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),(link_fn.cljs$core$IFn$_invoke$arity$1 ? link_fn.cljs$core$IFn$_invoke$arity$1(link) : link_fn.call(null,link))], null));

var G__46322 = (i__46317 + (1));
i__46317 = G__46322;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__46318),website_helpers$hyperlink_lists$link_list_$_iter__46315(cljs.core.chunk_rest(s__46316__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__46318),null);
}
} else {
var link = cljs.core.first(s__46316__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),(link_fn.cljs$core$IFn$_invoke$arity$1 ? link_fn.cljs$core$IFn$_invoke$arity$1(link) : link_fn.call(null,link))], null),website_helpers$hyperlink_lists$link_list_$_iter__46315(cljs.core.rest(s__46316__$2)));
}
} else {
return null;
}
...
return (function (){
var current_note = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__46319_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"path","path",-188191168).cljs$core$IFn$_invoke$arity$1(p1__46319_SHARP_),["content/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(current_page_path)].join(''));
}),notes));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),website_helpers.hyperlink_lists.link_list("Backlinks",new cljs.core.Keyword(null,"backlinks","backlinks",1645357998).cljs$core$IFn$_invoke$arity$1(current_note),website_helpers.hyperlink_lists.markdown_path_to_html_link),website_helpers.hyperlink_lists.link_list("Categories",new cljs.core.Keyword(null,"categories","categories",178386610).cljs$core$IFn$_invoke$arity$1(current_note),website_helpers.hyperlink_lists.category_link)], null);
});
}));
