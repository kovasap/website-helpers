...
(clojure.test.check.generators.Generator.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this21410,other21411){
var self__ = this;
var this21410__$1 = this;
return (((!((other21411 == null)))) && ((((this21410__$1.constructor === other21411.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21410__$1.gen,other21411.gen)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21410__$1.__extmap,other21411.__extmap)))))));
}));
...
var extmap__5385__auto__ = (function (){var G__22021 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__21419,new cljs.core.Keyword(null,"gen","gen",142575302));
if(cljs.core.record_QMARK_(G__21419)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__22021);
} else {
return G__22021;
}
})();
 ...
 * Internal function.
 */
clojure.test.check.generators.call_gen = (function clojure$test$check$generators$call_gen(p__22130,rnd,size){
var map__22132 = p__22130;
var map__22132__$1 = cljs.core.__destructure_map(map__22132);
var generator_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22132__$1,new cljs.core.Keyword(null,"gen","gen",142575302));
 ...
 * Internal function.
 */
clojure.test.check.generators.gen_fmap = (function clojure$test$check$generators$gen_fmap(k,p__22155){
...
return clojure.test.check.generators.make_gen((function (rnd,size){
var G__22161 = (h.cljs$core$IFn$_invoke$arity$2 ? h.cljs$core$IFn$_invoke$arity$2(rnd,size) : h.call(null,rnd,size));
return (k.cljs$core$IFn$_invoke$arity$1 ? k.cljs$core$IFn$_invoke$arity$1(G__22161) : k.call(null,G__22161));
}));
});
/**
 * Internal function.
 */
clojure.test.check.generators.gen_bind = (function clojure$test$check$generators$gen_bind(p__22173,k){
var map__22175 = p__22173;
var map__22175__$1 = cljs.core.__destructure_map(map__22175);
var h = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22175__$1,new cljs.core.Keyword(null,"gen","gen",142575302));
return clojure.test.check.generators.make_gen((function (rnd,size){
var vec__22178 = clojure.test.check.random.split(rnd);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22178,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22178,(1),null);
...
var vec__22210 = clojure.test.check.random.split(rr);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22210,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22210,(1),null);
...
return clojure.test.check.generators.gen_fmap((function (p1__22244_SHARP_){
return clojure.test.check.rose_tree.fmap(f,p1__22244_SHARP_);
}),gen);
});
/**
...
}),cljs.core.iterate((function (p1__22511_SHARP_){
return cljs.core.quot(p1__22511_SHARP_,(2));
}),n));
});
clojure.test.check.generators.shrink_int = (function clojure$test$check$generators$shrink_int(integer){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22518_SHARP_){
return (integer - p1__22518_SHARP_);
...
var map__22570 = generator;
var map__22570__$1 = cljs.core.__destructure_map(map__22570);
var gen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22570__$1,new cljs.core.Keyword(null,"gen","gen",142575302));
...
return clojure.test.check.rose_tree.filter((function (p1__22596_SHARP_){
return (((p1__22596_SHARP_ >= lower)) && ((p1__22596_SHARP_ <= upper)));
...
return clojure.test.check.generators.bind(clojure.test.check.generators.choose((0),(cljs.core.count(generators) - (1))),(function (p1__22613_SHARP_){
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(generators,p1__22613_SHARP_);
}));
});
/**
...
return cljs.core.count(cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__22624_SHARP_){
return (p1__22624_SHARP_ <= n);
...
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22652,(0),null);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22652,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2((function (){var iter__5523__auto__ = (function clojure$test$check$generators$frequency_$_iter__22674(s__22675){
return (new cljs.core.LazySeq(null,(function (){
var s__22675__$1 = s__22675;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__22675__$1);
if(temp__5825__auto__){
var s__22675__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__22675__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__22675__$2);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22678),clojure$test$check$generators$frequency_$_iter__22674(cljs.core.chunk_rest(s__22675__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22678),null);
}
} else {
var idx__$1 = cljs.core.first(s__22675__$2);
return cljs.core.cons(clojure.test.check.generators.call_gen(cljs.core.second(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(pairs__$1,idx__$1)),rnd,size),clojure$test$check$generators$frequency_$_iter__22674(cljs.core.rest(s__22675__$2)));
}
} else {
return null;
}
...
return clojure.test.check.generators.gen_fmap((function (p1__22719_SHARP_){
return clojure.test.check.rose_tree.fmap(v,p1__22719_SHARP_);
}),clojure.test.check.generators.choose((0),(cljs.core.count(v) - (1))));
});
clojure.test.check.generators.such_that_helper = (function clojure$test$check$generators$such_that_helper(pred,gen,p__22735,rng,size){
var map__22737 = p__22735;
var map__22737__$1 = cljs.core.__destructure_map(map__22737);
var ex_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22737__$1,new cljs.core.Keyword(null,"ex-fn","ex-fn",-284925510));
var max_tries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22737__$1,new cljs.core.Keyword(null,"max-tries","max-tries",-1824441792));
var tries_left = max_tries;
var rng__$1 = rng;
var size__$1 = size;
while(true){
if((tries_left === (0))){
throw (function (){var G__22761 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"pred","pred",1927423397),pred,new cljs.core.Keyword(null,"gen","gen",142575302),gen,new cljs.core.Keyword(null,"max-tries","max-tries",-1824441792),max_tries], null);
return (ex_fn.cljs$core$IFn$_invoke$arity$1 ? ex_fn.cljs$core$IFn$_invoke$arity$1(G__22761) : ex_fn.call(null,G__22761));
})();
} else {
var vec__22765 = clojure.test.check.random.split(rng__$1);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22765,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22765,(1),null);
var value = clojure.test.check.generators.call_gen(gen,r1,size__$1);
if(cljs.core.truth_((function (){var G__22771 = clojure.test.check.rose_tree.root(value);
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__22771) : pred.call(null,G__22771));
})())){
return clojure.test.check.rose_tree.filter(pred,value);
} else {
var G__24344 = (tries_left - (1));
var G__24345 = r2;
var G__24346 = (size__$1 + (1));
tries_left = G__24344;
rng__$1 = G__24345;
size__$1 = G__24346;
continue;
...
clojure.test.check.generators.default_such_that_opts = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ex-fn","ex-fn",-284925510),(function (p__22778){
var map__22779 = p__22778;
var map__22779__$1 = cljs.core.__destructure_map(map__22779);
var arg = map__22779__$1;
var max_tries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22779__$1,new cljs.core.Keyword(null,"max-tries","max-tries",-1824441792));
...
var G__24387 = (i__5770__auto___24384 + (1));
i__5770__auto___24384 = G__24387;
continue;
} else {
}
break;
 ...
 */
clojure.test.check.generators.neg_int = clojure.test.check.generators.fmap((function (p1__22870_SHARP_){
return ((-1) * p1__22870_SHARP_);
...
return clojure.test.check.generators.gen_bind(clojure.test.check.generators.sized((function (p1__22908_SHARP_){
return clojure.test.check.generators.choose((0),p1__22908_SHARP_);
})),(function (num_elements_rose){
return clojure.test.check.generators.gen_fmap((function (roses){
...
clojure.test.check.generators.swap = (function clojure$test$check$generators$swap(coll,p__22915){
var vec__22916 = p__22915;
var i1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22916,(0),null);
var i2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22916,(1),null);
...
while(true){
if((i__5770__auto___24459 < len__5769__auto___24457)){
args__5775__auto__.push((arguments[i__5770__auto___24459]));

var G__24461 = (i__5770__auto___24459 + (1));
i__5770__auto___24459 = G__24461;
continue;
} else {
}
break;
...
return cljs.core.zipmap(ks,p1__22943_SHARP_);
...
/** @this {Function} */
(clojure.test.check.generators.hash_map.cljs$lang$applyTo = (function (seq22948){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq22948));
}));
...
throw (function (){var G__23012 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"gen","gen",142575302),gen,new cljs.core.Keyword(null,"max-tries","max-tries",-1824441792),max_tries,new cljs.core.Keyword(null,"num-elements","num-elements",1960422107),num_elements], null);
return (ex_fn.cljs$core$IFn$_invoke$arity$1 ? ex_fn.cljs$core$IFn$_invoke$arity$1(G__23012) : ex_fn.call(null,G__23012));
})();
} else {
...
return (function() { 
var G__24479__delegate = function (rest__22982_SHARP_){
...
while (G__24480__i < G__24480__a.length) {G__24480__a[G__24480__i] = arguments[G__24480__i + 0]; ++G__24480__i;}
  rest__22982_SHARP_ = new cljs.core.IndexedSeq(G__24480__a,0,null);
} 
return G__24479__delegate.call(this,rest__22982_SHARP_);};
G__24479.cljs$lang$maxFixedArity = 0;
G__24479.cljs$lang$applyTo = (function (arglist__24481){
var rest__22982_SHARP_ = cljs.core.seq(arglist__24481);
return G__24479__delegate(rest__22982_SHARP_);
});
G__24479.cljs$core$IFn$_invoke$arity$variadic = G__24479__delegate;
return G__24479;
})()
;})(rose_trees,s,rng__$1,size__$1,tries))
,(function (){var G__23015 = rng__$1;
var G__23016 = cljs.core.persistent_BANG_(rose_trees);
return (shuffle_fn.cljs$core$IFn$_invoke$arity$2 ? shuffle_fn.cljs$core$IFn$_invoke$arity$2(G__23015,G__23016) : shuffle_fn.call(null,G__23015,G__23016));
})());
} else {
var vec__23019 = clojure.test.check.random.split(rng__$1);
var rng1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23019,(0),null);
var rng2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23019,(1),null);
...
var G__24485 = rose_trees;
var G__24486 = s;
var G__24487 = rng2;
var G__24488 = (size__$1 + (1));
var G__24489 = (tries + (1));
rose_trees = G__24485;
s = G__24486;
rng__$1 = G__24487;
size__$1 = G__24488;
...
var G__24491 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(rose_trees,rose);
var G__24492 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(s,k);
var G__24493 = rng2;
var G__24494 = size__$1;
var G__24495 = (0);
rose_trees = G__24491;
s = G__24492;
rng__$1 = G__24493;
...
var dec_card = (card - (1));
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(empty_coll,cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__23035,idx){
var vec__23036 = p__23035;
var v__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23036,(0),null);
var rng__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23036,(1),null);
...
clojure.test.check.generators.coll_distinct_by = (function clojure$test$check$generators$coll_distinct_by(empty_coll,key_fn,allows_dupes_QMARK_,ordered_QMARK_,gen,p__23070){
var map__23072 = p__23070;
var map__23072__$1 = cljs.core.__destructure_map(map__23072);
var num_elements = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23072__$1,new cljs.core.Keyword(null,"num-elements","num-elements",1960422107));
var min_elements = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23072__$1,new cljs.core.Keyword(null,"min-elements","min-elements",949370780));
var max_elements = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23072__$1,new cljs.core.Keyword(null,"max-elements","max-elements",433034073));
var max_tries = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__23072__$1,new cljs.core.Keyword(null,"max-tries","max-tries",-1824441792),(10));
var ex_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__23072__$1,new cljs.core.Keyword(null,"ex-fn","ex-fn",-284925510),(function (p1__23057_SHARP_){
return cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2("Couldn't generate enough distinct elements!",p1__23057_SHARP_);
}));
...
var size_pred = (function (p1__23058_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(num_elements,cljs.core.count(p1__23058_SHARP_));
});
...
return clojure.test.check.rose_tree.filter((cljs.core.truth_(allows_dupes_QMARK_)?cljs.core.every_pred.cljs$core$IFn$_invoke$arity$2(size_pred,(function (p1__23061_SHARP_){
return clojure.test.check.generators.distinct_by_QMARK_(key_fn,p1__23061_SHARP_);
...
var size_pred = (cljs.core.truth_(max_elements)?(function (p1__23062_SHARP_){
return (((min_elements__$1 <= cljs.core.count(p1__23062_SHARP_))) && ((cljs.core.count(p1__23062_SHARP_) <= max_elements)));
}):(function (p1__23064_SHARP_){
return (min_elements__$1 <= cljs.core.count(p1__23064_SHARP_));
}));
return clojure.test.check.generators.gen_bind((cljs.core.truth_(max_elements)?clojure.test.check.generators.choose(min_elements__$1,max_elements):clojure.test.check.generators.sized((function (p1__23067_SHARP_){
return clojure.test.check.generators.choose(min_elements__$1,(min_elements__$1 + p1__23067_SHARP_));
}))),(function (num_elements_rose){
var num_elements__$1 = clojure.test.check.rose_tree.root(num_elements_rose);
return clojure.test.check.generators.make_gen((function (rng,gen_size){
return clojure.test.check.rose_tree.filter((cljs.core.truth_(allows_dupes_QMARK_)?cljs.core.every_pred.cljs$core$IFn$_invoke$arity$2(size_pred,(function (p1__23068_SHARP_){
return clojure.test.check.generators.distinct_by_QMARK_(key_fn,p1__23068_SHARP_);
...
var G__24586 = ((function (){var G__23428 = res;
if(cljs.core.odd_QMARK_(res)){
var fexpr__23439 = (((res < (0)))?cljs.core.inc:cljs.core.dec);
return (fexpr__23439.cljs$core$IFn$_invoke$arity$1 ? fexpr__23439.cljs$core$IFn$_invoke$arity$1(G__23428) : fexpr__23439.call(null,G__23428));
} else {
return G__23428;
}
})() / (2));
...
return clojure.test.check.generators.gen_fmap((function (rose){
var vec__23465 = clojure.test.check.rose_tree.root(rose);
var bit_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23465,(0),null);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23465,(1),null);
 ...
 */
clojure.test.check.generators.large_integer_STAR_ = (function clojure$test$check$generators$large_integer_STAR_(p__23483){
var map__23486 = p__23483;
var map__23486__$1 = cljs.core.__destructure_map(map__23486);
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23486__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23486__$1,new cljs.core.Keyword(null,"max","max",61366548));
...
return clojure.test.check.generators.such_that.cljs$core$IFn$_invoke$arity$2((function (p1__23475_SHARP_){
return (((min__$1 <= p1__23475_SHARP_)) && ((p1__23475_SHARP_ <= max__$1)));
}),(((((min__$1 <= (0))) && (((0) <= max__$1))))?clojure.test.check.generators.large_integer_STAR__STAR_(min__$1,max__$1):(((max__$1 < (0)))?clojure.test.check.generators.fmap((function (p1__23476_SHARP_){
return (max__$1 + p1__23476_SHARP_);
}),clojure.test.check.generators.large_integer_STAR__STAR_((min__$1 - max__$1),(0))):clojure.test.check.generators.fmap((function (p1__23477_SHARP_){
return (min__$1 + p1__23477_SHARP_);
...
if((bit_count <= (32))){
return clojure.test.check.generators.choose((0),(function (){var G__23534 = cljs.core.long$(bit_count);
switch (G__23534) {
case (32):
return (4294967295);
...
return clojure.test.check.generators.fmap((function (p__23544){
var vec__23545 = p__23544;
var upper = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23545,(0),null);
var lower = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23545,(1),null);
return ((upper * (4294967296)) + lower);
}),clojure.test.check.generators.tuple.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (){var G__23553 = (bit_count - (32));
return (clojure.test.check.generators.uniform_integer.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.generators.uniform_integer.cljs$core$IFn$_invoke$arity$1(G__23553) : clojure.test.check.generators.uniform_integer.call(null,G__23553));
...
var G__24638 = ((out * (2)) + (n__$1 & (1)));
var G__24639 = (n__$1 / (2));
var G__24640 = (out_shifter / (2));
out = G__24638;
n__$1 = G__24639;
out_shifter = G__24640;
continue;
}
break;
}
...
return clojure.test.check.generators.fmap((function (p__23713){
var vec__23718 = p__23713;
var exp = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23718,(0),null);
var sign = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23718,(1),null);
var pair = vec__23718;
...
if((sign < (0))){
var vec__23756 = (function (){var G__23759 = exp;
var G__23760 = (- sign);
return (clojure.test.check.generators.block_bounds.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.generators.block_bounds.cljs$core$IFn$_invoke$arity$2(G__23759,G__23760) : clojure.test.check.generators.block_bounds.call(null,G__23759,G__23760));
})();
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23756,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23756,(1),null);
...
var pred = (cljs.core.truth_(lower_bound)?(cljs.core.truth_(upper_bound)?(function (p1__23765_SHARP_){
return (((lower_bound <= p1__23765_SHARP_)) && ((p1__23765_SHARP_ <= upper_bound)));
}):(function (p1__23766_SHARP_){
return (lower_bound <= p1__23766_SHARP_);
})):(cljs.core.truth_(upper_bound)?(function (p1__23767_SHARP_){
return (p1__23767_SHARP_ <= upper_bound);
}):null));
var gen = clojure.test.check.generators.fmap((function (p__23801){
var vec__23803 = p__23801;
var vec__23806 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23803,(0),null);
var exp = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23806,(0),null);
var sign = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23806,(1),null);
var significand = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23803,(1),null);
...
var vec__23832 = clojure.test.check.generators.block_bounds(exp,sign);
...
var block_lb = (function (){var G__23846 = low;
if(cljs.core.truth_(lower_bound)){
var x__5130__auto__ = G__23846;
...
var block_ub = (function (){var G__23853 = high;
if(cljs.core.truth_(upper_bound)){
var x__5133__auto__ = G__23853;
...
return clojure.test.check.generators.such_that.cljs$core$IFn$_invoke$arity$2(pred,G__23869);
} else {
return G__23869;
}
});
 ...
 */
clojure.test.check.generators.double_STAR_ = (function clojure$test$check$generators$double_STAR_(p__23889){
var map__23890 = p__23889;
var map__23890__$1 = cljs.core.__destructure_map(map__23890);
var infinite_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__23890__$1,new cljs.core.Keyword(null,"infinite?","infinite?",-2017886608),true);
var NaN_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__23890__$1,new cljs.core.Keyword(null,"NaN?","NaN?",-1917767651),true);
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23890__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23890__$1,new cljs.core.Keyword(null,"max","max",61366548));
var frequency_arg = (function (){var G__23891 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(95),clojure.test.check.generators.double_finite(min,max)], null)], null);
var G__23891__$1 = (((((min == null))?(((max == null)) || ((0.0 <= max))):(((max == null))?(min <= 0.0):(((min <= 0.0)) && ((0.0 <= max))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(G__23891,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(1),clojure.test.check.generators.return$(0.0)], null),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(1),clojure.test.check.generators.return$(-0.0)], null)], 0)):G__23891);
var G__23891__$2 = (cljs.core.truth_((function (){var and__5043__auto__ = infinite_QMARK_;
if(cljs.core.truth_(and__5043__auto__)){
return (max == null);
} else {
return and__5043__auto__;
}
})())?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__23891__$1,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(1),clojure.test.check.generators.return$(clojure.test.check.generators.POS_INFINITY)], null)):G__23891__$1);
var G__23891__$3 = (cljs.core.truth_((function (){var and__5043__auto__ = infinite_QMARK_;
if(cljs.core.truth_(and__5043__auto__)){
return (min == null);
} else {
return and__5043__auto__;
}
})())?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__23891__$2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(1),clojure.test.check.generators.return$(clojure.test.check.generators.NEG_INFINITY)], null)):G__23891__$2);
if(cljs.core.truth_(NaN_QMARK_)){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__23891__$3,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(1),clojure.test.check.generators.return$(clojure.test.check.generators.NAN)], null));
} else {
return G__23891__$3;
}
})();
 ...
 */
clojure.test.check.generators.symbol_name_or_namespace = clojure.test.check.generators.fmap((function (p__23946){
var vec__23947 = p__23946;
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23947,(0),null);
var cs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23947,(1),null);
...
}),clojure.test.check.generators.such_that.cljs$core$IFn$_invoke$arity$2((function (p__23950){
var vec__23957 = p__23950;
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23957,(0),null);
var vec__23961 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23957,(1),null);
var d = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23961,(0),null);
...
return clojure.test.check.generators.scale((function (p1__23965_SHARP_){
return cljs.core.long$(Math.pow(p1__23965_SHARP_,0.6));
}),g);
});
/**
 ...
 */
clojure.test.check.generators.symbol_ns = clojure.test.check.generators.resize_symbolish_generator(clojure.test.check.generators.fmap((function (p__23991){
var vec__23992 = p__23991;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23992,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23992,(1),null);
 ...
 */
clojure.test.check.generators.ratio = clojure.test.check.generators.fmap((function (p__23995){
...
return clojure.test.check.generators.one_of(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [clojure.test.check.generators.vector.cljs$core$IFn$_invoke$arity$1(inner_type),clojure.test.check.generators.list(inner_type),clojure.test.check.generators.set.cljs$core$IFn$_invoke$arity$1(clojure.test.check.generators.such_that.cljs$core$IFn$_invoke$arity$2(clojure.test.check.generators.hashable_QMARK_,inner_type)),clojure.test.check.generators.scale((function (p1__24042_SHARP_){
return cljs.core.quot(p1__24042_SHARP_,(2));
...
var log = Math.log(n);
var vec__24057 = clojure.test.check.random.split(rng);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24057,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24057,(1),null);
var n1 = cljs.core.long$(Math.exp(((clojure.test.check.random.rand_double(r1) * (log - log2_24784)) + log2_24784)));
...
var vec__24069 = clojure.test.check.random.split(rng);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24069,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24069,(1),null);
