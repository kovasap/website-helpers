...
var map__43825 = top_item;
var map__43825__$1 = cljs.core.__destructure_map(map__43825);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43825__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43825__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43825__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e43821){var _e = e43821;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5751__auto___43844 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5751__auto___43844)){
var seen_errors_43845 = temp__5751__auto___43844;
if(cljs.core.truth_(seen_errors_43845.has(self))){
} else {
seen_errors_43845.add(self);

var temp__5753__auto___43846 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5753__auto___43846)){
var sense_43847 = temp__5753__auto___43846;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_43847)].join(''));
} else {
}
}
} else {
