...
var i__4865__auto___45554 = (0);
while(true){
if((i__4865__auto___45554 < len__4864__auto___45553)){
args__4870__auto__.push((arguments[i__4865__auto___45554]));

var G__45555 = (i__4865__auto___45554 + (1));
i__4865__auto___45554 = G__45555;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__45460_45556 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__45461_45557 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__45462_45558 = true;
var _STAR_print_fn_STAR__temp_val__45463_45559 = (function (x__4796__auto__){
return sb__4795__auto__.append(x__4796__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__45462_45558);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__45463_45559);

try{var _STAR_print_level_STAR__orig_val__45464_45560 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__45465_45561 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__45465_45561);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__45464_45560);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__45461_45557);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__45460_45556);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq45457){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq45457));
}));
...
var new_formatters = current_formatters.filter((function (p1__45508_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__45508_SHARP_)));
}));
...
var G__45518_45578 = f;
var target__39908__auto___45579 = G__45518_45578;
if(cljs.core.truth_(target__39908__auto___45579)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__45518_45578)].join(''),"\n","target__39908__auto__"].join('')));
}

(target__39908__auto___45579["toString"] = (function (){
...
var G__45520_45584 = "%c%s";
var G__45521_45585 = "color:transparent";
var G__45522_45586 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__45520_45584,G__45521_45585,G__45522_45586) : f.call(null,G__45520_45584,G__45521_45585,G__45522_45586));
...
var args__4870__auto__ = [];
var len__4864__auto___45588 = arguments.length;
var i__4865__auto___45589 = (0);
while(true){
if((i__4865__auto___45589 < len__4864__auto___45588)){
args__4870__auto__.push((arguments[i__4865__auto___45589]));

var G__45590 = (i__4865__auto___45589 + (1));
i__4865__auto___45589 = G__45590;
continue;
} else {
}
break;
...
var vec__45529 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45529,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45529,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__45592__delegate = function (add_fmt,add_args){
...
var G__45592 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__45593__i = 0, G__45593__a = new Array(arguments.length -  1);
while (G__45593__i < G__45593__a.length) {G__45593__a[G__45593__i] = arguments[G__45593__i + 1]; ++G__45593__i;}
  add_args = new cljs.core.IndexedSeq(G__45593__a,0,null);
} 
return G__45592__delegate.call(this,add_fmt,add_args);};
G__45592.cljs$lang$maxFixedArity = 1;
G__45592.cljs$lang$applyTo = (function (arglist__45594){
var add_fmt = cljs.core.first(arglist__45594);
var add_args = cljs.core.rest(arglist__45594);
return G__45592__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq45524){
var G__45525 = cljs.core.first(seq45524);
var seq45524__$1 = cljs.core.next(seq45524);
var G__45526 = cljs.core.first(seq45524__$1);
var seq45524__$2 = cljs.core.next(seq45524__$1);
var G__45527 = cljs.core.first(seq45524__$2);
var seq45524__$3 = cljs.core.next(seq45524__$2);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45525,G__45526,G__45527,seq45524__$3);
}));
...
var seq__45536 = cljs.core.seq(features);
var chunk__45537 = null;
var count__45538 = (0);
var i__45539 = (0);
while(true){
if((i__45539 < count__45538)){
var feature = chunk__45537.cljs$core$IIndexed$_nth$arity$2(null,i__45539);
...
var G__45597 = seq__45536;
var G__45598 = chunk__45537;
var G__45599 = count__45538;
var G__45600 = (i__45539 + (1));
seq__45536 = G__45597;
chunk__45537 = G__45598;
count__45538 = G__45599;
i__45539 = G__45600;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__45536);
if(temp__5753__auto__){
var seq__45536__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__45536__$1)){
var c__4679__auto__ = cljs.core.chunk_first(seq__45536__$1);
var G__45603 = cljs.core.chunk_rest(seq__45536__$1);
var G__45604 = c__4679__auto__;
var G__45605 = cljs.core.count(c__4679__auto__);
var G__45606 = (0);
seq__45536 = G__45603;
chunk__45537 = G__45604;
count__45538 = G__45605;
i__45539 = G__45606;
continue;
} else {
var feature = cljs.core.first(seq__45536__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__45608 = cljs.core.next(seq__45536__$1);
var G__45609 = null;
var G__45610 = (0);
var G__45611 = (0);
seq__45536 = G__45608;
chunk__45537 = G__45609;
count__45538 = G__45610;
i__45539 = G__45611;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5751__auto__)){
var o45550 = temp__5751__auto__;
return (o45550["version"]);
} else {
return null;
}
})() == null);
